...
namespace cds {
    ...
    template <
            meta :: EnableIf <
                    ...
                    meta :: isBasicPointer < __ElementType > ()
            >
    > __CDS_cpplang_NonConstConstexprMemberFunction auto AtomicReference < __ElementType > :: operator ++ () noexcept -> __ElementType {
    ...
    template <
            meta :: EnableIf <
                    ...
                    meta :: isBasicPointer < __ElementType > ()
            >
    > __CDS_cpplang_NonConstConstexprMemberFunction auto AtomicReference < __ElementType > :: operator ++ (int) noexcept -> __ElementType {
