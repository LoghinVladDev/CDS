...
namespace cds { // NOLINT(modernize-concat-nested-namespaces)
    namespace meta {
         ...
         */
        template < typename __Type > auto valueOf () noexcept -> __Type;
         ...
         * @return does not return anything, as implementation does not exist.
         */
        template < typename __Type > auto referenceOf () noexcept -> __Type &;
         ...
         * @return does not return anything, as implementation does not exist.
         */
        template < typename __Type > auto addressOf () noexcept -> __Type *;
        ...
        namespace __impl {
             ...
             */
            template < typename __IntegralType, __IntegralType __value >
            struct __IntegralConstant {
            ...
            using __BoolConstant = __IntegralConstant < bool, __value >;

            /**
             * @brief True Bool Constant implementation container structure
             */
            using __TrueType  = __BoolConstant < true >;

            /**
             * @brief False Bool Constant implementation container structure
             */
            using __FalseType = __BoolConstant < false >;
            ...
            template < typename __ReplacedType >
             ...
             */
            template < bool, typename __TypeIfTrue, typename >
            struct __Conditional {
                /// by default, save the type intended for the true case
                using Type = __TypeIfTrue;
            };

            template < typename __TypeIfTrue, typename __TypeIfFalse >
             ...
             */
            template < typename __T > struct __RemoveConst                                  { using Type = __T; };
            template < typename __T > struct __RemoveConst < __T const >                    { using Type = __T; };
             ...
             */
            template < typename __T > struct __RemoveVolatile                               { using Type = __T; };
            template < typename __T > struct __RemoveVolatile < __T volatile >              { using Type = __T; };
             ...
             */
            template < typename __T > struct __RemoveReference                              { using Type = __T; };
            template < typename __T > struct __RemoveReference < __T & >                    { using Type = __T; };
            template < typename __T > struct __RemoveReference < __T && >                   { using Type = __T; };
             ...
             */
            template < typename __T > struct __RemoveConstVolatile                          { using Type = __T; };
            template < typename __T > struct __RemoveConstVolatile < __T const >            { using Type = __T; };
            template < typename __T > struct __RemoveConstVolatile < __T volatile >         { using Type = __T; };
            template < typename __T > struct __RemoveConstVolatile < __T const volatile >   { using Type = __T; };
            ...
            namespace __removePtrImpl {
                 ...
                 */
                template < typename __T, typename >     struct __RemovePointer                { using Type = __T; };
                template < typename __T, typename __U > struct __RemovePointer < __T, __U * > { using Type = __U; };
            }
             ...
             * @tparam __T type to remove pointer for
             */
            template < typename __T > struct __RemovePointer : __removePtrImpl :: __RemovePointer < __T, typename __RemoveConstVolatile < __T > :: Type > {};
            ...
            struct __RemoveExtent {
                using Type = __T;
            };

            template < typename __T, Size __size >
            ...
            struct __IsReferenceable : __FalseType {};
            ...
            namespace __isVoidImpl {
                 ...
                 */
                template < typename >   struct __IsVoid           : __FalseType {};
             ...
             */
            template < typename __T >
            struct __IsVoid : __isVoidImpl :: __IsVoid < __RemoveConstVolatile < __T > > :: __Type {};
            ...
            namespace __addPtrImpl {
                 ...
                 */
                template < typename __T, bool = __IsReferenceable < __T > :: value || __IsVoid < __T > :: value >
                struct __AddPointer {
                    using Type = __T;
                };
             ...
             */
            template < typename __T > struct __AddConstVolatile     { using Type = typename __AddConst < typename __AddVolatile < __T > :: Type > :: Type; };
            ...
            namespace __addReferenceImpl {
                 ...
                 */
                template < typename __T, bool = __IsReferenceable < __T > :: value >
                struct __AddLValueReference                 { using Type = __T; };
                 ...
                 */
                template < typename __T, bool = __IsReferenceable < __T > :: value >
                struct __AddRValueReference                 { using Type = __T; };
             ...
             * @tparam __T type to add a lvalue reference to
             */
            template < typename __T > struct __AddLValueReference : __addReferenceImpl :: __AddLValueReference < __T > {};

            /**
             * @brief Meta-type implementation used to obtain a rvalue reference (&&) type of the given type
             * @tparam __T type to add a rvalue reference to
             */
            template < typename __T > struct __AddRValueReference : __addReferenceImpl :: __AddRValueReference < __T > {};
        }
         ...
         * @tparam __ReplacedType is the type that is saved inside the structure if the condition is true
         */
        template < bool __enableCondition, typename __ReplacedType = int >
         ...
         * @tparam __T type to remove const modifier for
         */
        template < typename __T > using RemoveConst           = typename __impl :: __RemoveConst < __T > :: Type;

        /**
         * @brief Meta-type used to acquire the non-volatile type corresponding the current type
         * @tparam __T type to remove volatile modifier for
         */
        template < typename __T > using RemoveVolatile        = typename __impl :: __RemoveVolatile < __T > :: Type;

        /**
         * @brief Meta-type used to acquire the non-reference type corresponding the current type
         * @tparam __T type to remove reference for
         */
        template < typename __T > using RemoveReference       = typename __impl :: __RemoveReference < __T > :: Type;

        /**
         * @brief Meta-type used to acquire the non-const, non-volatile type corresponding the current type
         * @tparam __T type to remove const and volatile modifiers for
         */
        template < typename __T > using RemoveConstVolatile   = typename __impl :: __RemoveConstVolatile < __T > :: Type;

        /**
         * @brief Meta-type used to acquire the non-pointer type corresponding the current type
         * @tparam __T type to remove pointer for
         */
        template < typename __T > using RemovePointer         = typename __impl :: __RemovePointer < __T > :: Type;

        /**
         * @brief Meta-type used to acquire the non-array extent type corresponding the current type
         * @tparam __T type to remove the array extent ([] or [size]) for
         */
        template < typename __T > using RemoveExtent          = typename __impl :: __RemoveExtent < __T > :: Type;

        /**
         * @brief Meta-type used to acquire the non-array extent type corresponding the current type, until no extent exists
         * @tparam __T type to remove all extents for - if T is T[][][], Type will be T
         */
        template < typename __T > using RemoveAllExtents      = typename __impl :: __RemoveAllExtents < __T > :: Type;
         ...
         * @tparam __T type to add const to
         */
        template < typename __T > using AddConst              = typename __impl :: __AddConst < __T > :: Type;

        /**
         * @brief Meta-type used to obtain a volatile type of the given type
         * @tparam __T type to add volatile to
         */
        template < typename __T > using AddVolatile           = typename __impl :: __AddVolatile < __T > :: Type;

        /**
         * @brief Meta-type used to obtain a lvalue reference (&) type of the given type
         * @tparam __T type to add a lvalue reference to
         */
        template < typename __T > using AddLValueReference    = typename __impl :: __AddLValueReference < __T > :: Type;

        /**
         * @brief Meta-type used to obtain a rvalue reference (&&) type of the given type
         * @tparam __T type to add a rvalue reference to
         */
        template < typename __T > using AddRValueReference    = typename __impl :: __AddRValueReference < __T > :: Type;

        /**
         * @brief Meta-type used to obtain a const volatile type of the given type
         * @tparam __T type to add const and volatile to
         */
        template < typename __T > using AddConstVolatile      = typename __impl :: __AddConstVolatile < __T > :: Type;

        /**
         * @brief Meta-type implementation used to obtain a pointer to the given type
         * @tparam __T type to add a pointer to
         */
        template < typename __T > using AddPointer            = typename __impl :: __AddPointer < __T > :: Type;
