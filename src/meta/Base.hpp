...
/// \tparam __T is the type of the required value
/// \return does not return anything, as implementation does not exist.
template <typename __T> auto valueOf () noexcept -> __T; // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
...
/// \tparam __T is the type of the required reference
/// \return does not return anything, as implementation does not exist.
template <typename __T> auto referenceOf () noexcept -> __T&; // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)

/// \brief Meta-function implementation used for obtaining a pseudo-pointer of type T. Not to be used in actual compiled code
/// \tparam __T is the type of the required pointer
/// \return does not return anything, as implementation does not exist.
template <typename __T> auto addressOf () noexcept -> __T*; // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
...
template <bool __value, typename = void>                        // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
...
/// \tparam __ReplacedType is the type that is saved inside the structure if the condition is true
...
/// \tparam __T type to remove const modifier for
...
/// \tparam __T type to remove volatile modifier for
...
/// \tparam __T type to remove reference for
...
/// \tparam __T type to remove const and volatile modifiers for
...
/// \tparam __T type to remove pointer for
...
/// \tparam __T type to remove the array extent ([] or [size]) for
...
/// \tparam __T type to remove all extents for - if T is T[][][], Type will be T
template <typename __T>   // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
...
/// \tparam __T type to check if is referenceable
...
template <typename __T> // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
struct __IsStaticFunction <__T> : __And <__IsFunction <__T>, __Not <__IsObjectFunction <__T>>> {};
...
/// \tparam __From is the type being converted
/// \tparam __To is the type to which the conversion is done
template <typename __From, typename __To, bool = __Or <__IsVoid <__From>, __IsFunction <__To>, __IsArray <__To>>::value>  // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
struct __IsConvertible : __IsVoid <__To> {};                                                                              // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
...
/// \tparam __LeftType is the first type
/// \tparam __RightType is the second type
...
template <typename __T> // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
struct __IsSame <__T, __T> : __TrueType {};
...
/// \tparam __T type to add a pointer to
template < typename __T, bool = __Or <__IsReferenceable <__T>, __IsVoid <__T>>::value>  // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
...
/// \tparam __T type to add const to
...
/// \tparam __T type to add volatile to
...
/// \tparam __T type to add const and volatile to
...
/// \tparam __T type to add a lvalue reference to
...
/// \tparam __T type to add a rvalue reference to
template < typename __T, bool = __IsReferenceable <__T>::value >    // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
...
template <template <typename...> class __PredicateFormula, typename ... __Ts>  // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
...
template <template <typename...> class __PredicateFormula, typename ... __Ts>  // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
struct __NoneImpl : __Not <__AllImpl <__PredicateFormula, __Ts...>> {};        // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
...
/// \tparam __TIfTrue is the type to save if condition is true
/// \tparam __TIfFalse is the type to save if condition is false
template < bool __condition, typename __TIfTrue, typename __TIfFalse > // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
using Conditional = typename __impl::__Conditional < __condition, __TIfTrue, __TIfFalse >::Type;
...
constexpr auto isEnum () noexcept -> bool {
  return __impl::__IsEnum <__T>::value;
}
...
constexpr auto isUnion () noexcept -> bool {
  return __impl::__IsUnion <__T>::value;
}
...
constexpr auto isClass () noexcept -> bool {
  return __impl::__IsClass <__T>::value;
}
...
constexpr auto isFunction () noexcept -> bool {
  return __impl::__IsFunction <__T>::value;
}
...
constexpr auto isFundamental () noexcept -> bool {
  return __impl::__IsFundamental <__T>::value;
}
...
constexpr auto isIntegral () noexcept -> bool {
  return __impl::__IsIntegral <__T>::value;
}
...
constexpr auto isFloatingPoint () noexcept -> bool {
  return __impl::__IsFloatingPoint <__T>::value;
}
...
constexpr auto isArithmetic () noexcept -> bool {
  return __impl::__IsArithmetic <__T>::value;
}
...
constexpr auto isSigned () noexcept -> bool {
  return __impl::__IsSigned <__T>::value;
}
...
constexpr auto isDefaultConstructible () noexcept -> bool {
  return __impl::__IsDefaultConstructible <__T>::value;
}

template <typename __T> // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
struct IsDefaultConstructible : __impl::__IsDefaultConstructible <__T> {};
...
constexpr auto isTriviallyCopyable () noexcept -> bool {
  return __impl::__IsTriviallyCopyable <__T>::value;
}
...
constexpr auto isCopyConstructible () noexcept -> bool {
  return __impl::__IsCopyConstructible <__T>::value;
}

template <typename __T> // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
struct IsCopyConstructible : __impl::__IsCopyConstructible <__T> {};
...
constexpr auto isMoveConstructible () noexcept -> bool {
  return __impl::__IsMoveConstructible <__T>::value;
}

template <typename __T> // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
struct IsMoveConstructible : __impl::__IsMoveConstructible <__T> {};
...
constexpr auto isCopyAssignable () noexcept -> bool {
  return __impl::__IsCopyAssignable <__T>::value;
}

template <typename __T> // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
struct IsCopyAssignable : __impl::__IsCopyAssignable <__T> {};
...
constexpr auto isMoveAssignable () noexcept -> bool {
  return __impl::__IsMoveAssignable <__T>::value;
}

template <typename __T> // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
struct IsMoveAssignable : __impl::__IsMoveAssignable <__T> {};
...
constexpr auto isCallable () noexcept -> bool {
  return __impl::__IsFunction <__T>::value || __impl::__IsObjectFunction <__T>::value;
}

template <typename __T> // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
struct IsCallable : Or <__impl::__IsFunction <__T>, __impl::__IsObjectFunction <__T>> {};
...
constexpr auto isStaticFunction () noexcept -> bool {
  return __impl::__IsStaticFunction <__T>::value;
}

template <typename __T> // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
struct IsStaticFunction : __impl::__IsStaticFunction <__T> {};
...
constexpr auto isObjectFunction () noexcept -> bool {
  return __impl::__IsObjectFunction <__T>::value;
}

template <typename __T> // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
struct IsObjectFunction : __impl::__IsObjectFunction <__T> {};

/// \brief Meta-function used to check if a given type is an array type
/// \tparam __T is the type checked
template <typename __T> // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
constexpr auto isArray () noexcept -> bool {
  return __impl::__IsArray <__T>::value;
}

template <typename __T> // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
struct IsArray : __impl::__IsArray <__T> {};

/// \brief Meta-function used to check if a given type is a bounded array type
/// \tparam __T is the type checked
template <typename __T> // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
constexpr auto isBoundedArray () noexcept -> bool {
  return __impl::__IsBoundedArray <__T>::value;
}

template <typename __T> // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
struct IsBoundedArray : __impl::__IsBoundedArray <__T> {};
...
constexpr auto isUnboundedArray () noexcept -> bool {
  return __impl::__IsUnboundedArray <__T>::value;
}

template <typename __T> // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
struct IsUnboundedArray : __impl::__IsUnboundedArray <__T> {};
...
constexpr auto isBasicPointer () noexcept -> bool {
  return __impl::__IsPointer <__T>::value;
}

template <typename __T> // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
struct IsBasicPointer : __impl::__IsPointer <__T> {};
...
constexpr auto isLValueReference () noexcept -> bool {
  return __impl::__IsLValueReference <__T>::value;
}

template <typename __T> // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
struct IsLValueReference : __impl::__IsLValueReference <__T> {};
...
constexpr auto isRValueReference () noexcept -> bool {
  return __impl::__IsRValueReference <__T>::value;
}

template <typename __T> // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
struct IsRValueReference : __impl::__IsRValueReference <__T> {};
...
template <typename __T> // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
struct IsReference : IsLValueReference <__T> {};
...
template <typename __T> // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
struct IsMoveReference : IsRValueReference <__T> {};
...
template <typename __T> // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
struct IsVolatile : __impl::__IsVolatile <__T> {};
...
template <typename __T> // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
struct IsConst : __impl::__IsConst <__T> {};
