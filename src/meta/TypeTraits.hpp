...
namespace cds { /* NOLINT(modernize-concat-nested-namespaces) */
    ...
    namespace meta {        /* NOLINT(modernize-concat-nested-namespaces) */
        namespace __impl {  /* NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp) */
             ...
             * @tparam __RightType is the second type
             */
            template < typename __LeftType, typename __RightType, typename = Void <> > struct __LessThanPossible : __FalseType {}; /* NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp) */
             ...
             * @tparam __RightType is the second type
             */
            template < typename __LeftType, typename __RightType, typename = Void <> > struct __GreaterThanPossible : __FalseType {}; /* NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp) */
             ...
             * @tparam __RightType is the second type
             */
            template < typename __LeftType, typename __RightType, typename = Void <> > struct __LessThanOrEqualToPossible : __FalseType {}; /* NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp) */
             ...
             * @tparam __RightType is the second type
             */
            template < typename __LeftType, typename __RightType, typename = Void <> > struct __GreaterThanOrEqualToPossible : __FalseType {}; /* NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp) */
             ...
             * @tparam __RightType is the second type
             */
            template < typename __LeftType, typename __RightType, typename = Void <> > struct __EqualToPossible : __FalseType {}; /* NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp) */
             ...
             * @tparam __RightType is the second type
             */
            template < typename __LeftType, typename __RightType, typename = Void <> > struct __NotEqualToPossible : __FalseType {}; /* NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp) */

            template < typename __Type, typename = Void <> > struct __IndirectionPossible : __FalseType {}; /* NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp) */

            template < typename __Type, typename = Void <> > struct __PrefixIncrementPossible : __FalseType {}; /* NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp) */
            ...
            struct __IsBaseOf : __BoolConstant <                        /* NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp) */
             ...
             * </ul>
             */
            template < typename ... __TypePack >    struct __Common;                                    /* NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp) */
         ...
         */
        template < typename ... __Types >           using Common        = typename __impl :: __Common < __Types ... > :: Type;  /* NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp) */
...
#define __CDS_Meta_RegisterParseType(_type) /* NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp) */  \
namespace cds {                                                                         \
    namespace meta {                                                                    \
        namespace __impl {                                                              \
            template <>                                                                 \
...
#define __CDS_Meta_RegisterParseTemplateType(_type) /* NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp) */  \
namespace cds {                                                                                 \
    namespace meta {                                                                            \
        namespace __impl {                                                                      \
