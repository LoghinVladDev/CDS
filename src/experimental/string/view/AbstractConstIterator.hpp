...
#ifndef __CDS_EX_STRING_VIEW_BASE_ABSTRACT_CONST_ITERATOR_HPP__
#define __CDS_EX_STRING_VIEW_BASE_ABSTRACT_CONST_ITERATOR_HPP__
...
#endif // __CDS_EX_STRING_VIEW_BASE_ABSTRACT_CONST_ITERATOR_HPP__
