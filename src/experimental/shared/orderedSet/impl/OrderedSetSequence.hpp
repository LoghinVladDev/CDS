...
#if defined ( __CDS_EX_ORDERED_SET_HPP__ ) && defined ( CDS_SEQUENCE_HPP )

#ifndef __CDS_EX_ORDERED_SET_SEQUENCE_IMPL_HPP__
#define __CDS_EX_ORDERED_SET_SEQUENCE_IMPL_HPP__
...
#endif //__CDS_EX_ORDERED_SET_SEQUENCE_IMPL_HPP__
