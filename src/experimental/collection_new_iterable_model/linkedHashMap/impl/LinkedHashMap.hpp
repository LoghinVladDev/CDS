...
#ifndef __CDS_EX_LINKED_HASH_MAP_IMPL_HPP__
#define __CDS_EX_LINKED_HASH_MAP_IMPL_HPP__ /* NOLINT(bugprone-reserved-identifier) */
...
#endif /* __CDS_EX_LINKED_HASH_MAP_IMPL_HPP__ */
