        ...
        namespace __hidden {    // NOLINT(modernize-concat-nested-namespaces, bugprone-reserved-identifier)
            namespace __impl {  // NOLINT(bugprone-reserved-identifier)
                ...
                > void ( Collection < __ElementType > :: * const __ListServer < __ReceiverType, __ElementType > :: __routingTable [0x13U] ) () = { // NOLINT(bugprone-reserved-identifier)
                        ...
                        reinterpret_cast < void ( Collection < __ElementType > :: * ) () > ( & __ReceiverType :: __newBefore ),             /* __cirt_newBeforeAddress */
                        reinterpret_cast < void ( Collection < __ElementType > :: * ) () > ( & __ReceiverType :: __newBeforeConst ),        /* __cirt_newBeforeAddressConst */
                        reinterpret_cast < void ( Collection < __ElementType > :: * ) () > ( & __ReceiverType :: __newAfter ),              /* __cirt_newAfterAddress */
                        reinterpret_cast < void ( Collection < __ElementType > :: * ) () > ( & __ReceiverType :: __newAfterConst ),         /* __cirt_newAfterAddressConst */
                        reinterpret_cast < void ( Collection < __ElementType > :: * ) () > ( & __ReceiverType :: __newBeforeArray ),        /* __cirt_newBeforeAddressArray */
                        reinterpret_cast < void ( Collection < __ElementType > :: * ) () > ( & __ReceiverType :: __newBeforeArrayConst ),   /* __cirt_newBeforeAddressArrayConst */
                        reinterpret_cast < void ( Collection < __ElementType > :: * ) () > ( & __ReceiverType :: __newAfterArray ),         /* __cirt_newAfterAddressArray */
                        reinterpret_cast < void ( Collection < __ElementType > :: * ) () > ( & __ReceiverType :: __newAfterArrayConst )     /* __cirt_newAfterAddressArrayConst */
                };
