...
#ifndef __CDS_EX_SHARED_MAP_SERVER_DISPATCHER_HPP__
#define __CDS_EX_SHARED_MAP_SERVER_DISPATCHER_HPP__ /* NOLINT(bugprone-reserved-identifier) */
    ...
    namespace experimental {    /* NOLINT(modernize-concat-nested-namespaces) */
        namespace __hidden {    /* NOLINT(modernize-concat-nested-namespaces, bugprone-reserved-identifier) */
            namespace __impl {  /* NOLINT(bugprone-reserved-identifier) */
                ...
                > using __MapServerDispatcher __CDS_DeprecatedHint("No longer an experimental feature.") =                                                              /* NOLINT(bugprone-reserved-identifier) */
                        cds :: __hidden :: __impl :: __MapServerDispatcher <
                                __ServerType, __ServiceType, __ElementType, __KeyType,
...
#endif /* __CDS_EX_SHARED_MAP_SERVER_DISPATCHER_HPP__ */
