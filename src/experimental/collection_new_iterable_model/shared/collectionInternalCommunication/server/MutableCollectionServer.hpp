...
#define __CDS_SHARED_MUTABLE_COLLECTION_SERVER_HPP__
    ...
    namespace experimental {    // NOLINT(modernize-concat-nested-namespaces)
        namespace __hidden {    // NOLINT(modernize-concat-nested-namespaces, bugprone-reserved-identifier)
            namespace __impl {  // NOLINT(bugprone-reserved-identifier)
                ...
                protected:
                    constexpr auto __mcs_handlers () const noexcept -> __GenericHandler const *; // NOLINT(bugprone-reserved-identifier)

                protected:
                    constexpr auto __mcs_constHandlers () const noexcept -> __GenericConstHandler const *;   // NOLINT(bugprone-reserved-identifier)
                };
