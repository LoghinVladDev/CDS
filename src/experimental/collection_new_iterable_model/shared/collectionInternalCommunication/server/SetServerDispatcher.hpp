...
#ifndef __CDS_EX_SHARED_SET_SERVER_DISPATCHER_HPP__
    ...
    namespace experimental {    /* NOLINT(modernize-concat-nested-namespaces) */
        namespace __hidden {    /* NOLINT(modernize-concat-nested-namespaces, bugprone-reserved-identifier) */
            namespace __impl {  /* NOLINT(bugprone-reserved-identifier) */
                ...
                > using __SetServerDispatcher __CDS_DeprecatedHint("No longer an experimental feature.") =                                                                /* NOLINT(bugprone-reserved-identifier) */
                        cds :: __hidden :: __impl :: __SetServerDispatcher <
...
#endif /* __CDS_EX_SHARED_SET_SERVER_DISPATCHER_HPP__ */
