...
#ifndef __CDS_SHARED_INDICES_BY_CLIENT_HPP__
#define __CDS_SHARED_INDICES_BY_CLIENT_HPP__
    ...
    namespace experimental {    // NOLINT(modernize-concat-nested-namespaces)
        namespace __hidden {    // NOLINT(modernize-concat-nested-namespaces, bugprone-reserved-identifier)
            namespace __impl {  // NOLINT(bugprone-reserved-identifier)
                ...
                > class __IndicesByClient {         // NOLINT(bugprone-reserved-identifier)
                ...
                template <
                        typename __ReceiverType,            // NOLINT(bugprone-reserved-identifier)
                        typename __ElementType              // NOLINT(bugprone-reserved-identifier)
                > using __LocalIndicesByClient =            // NOLINT(bugprone-reserved-identifier)
                        __IndicesByClient <
                                __ReceiverType,
                                __ElementType
                        >;
...
#endif // __CDS_SHARED_INDICES_BY_CLIENT_HPP__
