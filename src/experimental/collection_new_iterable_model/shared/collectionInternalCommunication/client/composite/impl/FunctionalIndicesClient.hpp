...
#ifndef __CDS_SHARED_FUNCTIONAL_INDICES_CLIENT_IMPL_HPP__
#define __CDS_SHARED_FUNCTIONAL_INDICES_CLIENT_IMPL_HPP__
    ...
    namespace experimental {    // NOLINT(modernize-concat-nested-namespaces)
        namespace __hidden {    // NOLINT(modernize-concat-nested-namespaces, bugprone-reserved-identifier)
            namespace __impl {  // NOLINT(bugprone-reserved-identifier)
                ...
                > auto __FunctionalIndicesClient <
                        __ReceiverType,
                        __ElementType
                > :: indicesOfThat (
                        Size                        count,
                ...
                > template <
                        ...
                        typename __Predicate                                // NOLINT(bugprone-reserved-identifier)
                > __CDS_OptimalInline auto __FunctionalIndicesClient <
                        __ReceiverType,
                        __ElementType
                > :: indicesOfThat (
                        Size                        count,
...
#endif // __CDS_SHARED_FUNCTIONAL_INDICES_CLIENT_IMPL_HPP__
