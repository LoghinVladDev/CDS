...
#ifndef __CDS_SHARED_REMOVE_OF_CLIENT_IMPL_HPP__
#define __CDS_SHARED_REMOVE_OF_CLIENT_IMPL_HPP__
        ...
        namespace __hidden {    // NOLINT(modernize-concat-nested-namespaces, bugprone-reserved-identifier)
            namespace __impl {  // NOLINT(bugprone-reserved-identifier)
                ...
                > template <
                        ...
                        >
                > __CDS_OptimalInline auto __RemoveOfClient <
                        __IterableType,
                        __ElementType,
                        __FromIterableType,
                        __containsFunction
...
#endif // __CDS_SHARED_REMOVE_OF_CLIENT_IMPL_HPP__
