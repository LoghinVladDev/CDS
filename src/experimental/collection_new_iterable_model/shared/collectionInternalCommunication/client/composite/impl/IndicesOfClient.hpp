...
#ifndef __CDS_SHARED_INDICES_OF_CLIENT_IMPL_HPP__
#define __CDS_SHARED_INDICES_OF_CLIENT_IMPL_HPP__
    ...
    namespace experimental {    // NOLINT(modernize-concat-nested-namespaces)
        namespace __hidden {    // NOLINT(modernize-concat-nested-namespaces, bugprone-reserved-identifier)
            namespace __impl {  // NOLINT(bugprone-reserved-identifier)
                ...
                > __CDS_OptimalInline auto __IndicesOfClient <
                        __ReceiverType,
                        __ElementType,
                        __FromCollectionType,
                        __contains
...
#endif // __CDS_SHARED_INDICES_OF_CLIENT_IMPL_HPP__
