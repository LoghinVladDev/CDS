...
#ifndef __CDS_SHARED_GENERIC_MUTABLE_STATEMENTS_CLIENT_IMPL_HPP__
#define __CDS_SHARED_GENERIC_MUTABLE_STATEMENTS_CLIENT_IMPL_HPP__
    ...
    namespace experimental {    // NOLINT(modernize-concat-nested-namespaces)
        namespace __hidden {    // NOLINT(modernize-concat-nested-namespaces, bugprone-reserved-identifier)
            namespace __impl {  // NOLINT(bugprone-reserved-identifier)
                ...
                > __CDS_OptimalInline auto __GenericMutableStatementsClient <
                        __IterableType,
                        __ElementType
                > :: forEach (
...
#endif // __CDS_SHARED_GENERIC_MUTABLE_STATEMENTS_CLIENT_IMPL_HPP__
