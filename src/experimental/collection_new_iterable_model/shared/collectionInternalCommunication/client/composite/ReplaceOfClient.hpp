...
#ifndef __CDS_SHARED_REPLACE_OF_CLIENT_HPP__
#define __CDS_SHARED_REPLACE_OF_CLIENT_HPP__
    ...
    namespace experimental {
        namespace __hidden {
            namespace __impl {
                ...
                > class __ReplaceOfClient {                                                             // NOLINT(bugprone-reserved-identifier)
                ...
                template <
                        ...
                        typename                                                    __OfCollectionType, // NOLINT(bugprone-reserved-identifier)
                        __ContainsFunction < __OfCollectionType, __ElementType >    __contains          // NOLINT(bugprone-reserved-identifier)
                > using __LocalReplaceOfClient =                                                        // NOLINT(bugprone-reserved-identifier)
                        __ReplaceOfClient <
                                __ReceiverType,
                                __ElementType,
                                __OfCollectionType,
...
#endif // __CDS_SHARED_REPLACE_OF_CLIENT_HPP__
