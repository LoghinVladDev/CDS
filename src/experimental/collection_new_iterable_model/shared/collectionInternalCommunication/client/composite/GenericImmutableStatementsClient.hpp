...
#ifndef __CDS_SHARED_GENERIC_IMMUTABLE_STATEMENTS_CLIENT_HPP__
#define __CDS_SHARED_GENERIC_IMMUTABLE_STATEMENTS_CLIENT_HPP__
    ...
    namespace experimental {    // NOLINT(modernize-concat-nested-namespaces)
        namespace __hidden {    // NOLINT(modernize-concat-nested-namespaces, bugprone-reserved-identifier)
            namespace __impl {  // NOLINT(bugprone-reserved-identifier)
                ...
                > class __GenericImmutableStatementsClient {    // NOLINT(bugprone-reserved-identifier)
                ...
                template <
                        typename __IterableType,                    // NOLINT(bugprone-reserved-identifier)
                        typename __ElementType                      // NOLINT(bugprone-reserved-identifier)
                > using __LocalGenericImmutableStatementsClient =
                        __GenericImmutableStatementsClient <
                                __IterableType,
                                __ElementType
                        >;
...
#endif // __CDS_SHARED_GENERIC_IMMUTABLE_STATEMENTS_CLIENT_HPP__
