...
#ifndef __CDS_SHARED_FIND_OF_MUTABLE_CLIENT_HPP__
#define __CDS_SHARED_FIND_OF_MUTABLE_CLIENT_HPP__
    ...
    namespace experimental {    // NOLINT(modernize-concat-nested-namespaces)
        namespace __hidden {    // NOLINT(modernize-concat-nested-namespaces, bugprone-reserved-identifier)
            namespace __impl {  // NOLINT(bugprone-reserved-identifier)
                ...
                > class __FindOfMutableClient {                                                         // NOLINT(bugprone-reserved-identifier)
                ...
                template <
                        ...
                        typename                                                    __FromIterableType, // NOLINT(bugprone-reserved-identifier)
                        __ContainsFunction < __FromIterableType, __ElementType >    __containsFunction  // NOLINT(bugprone-reserved-identifier)
                > using __LocalFindOfMutableClient =                                                    // NOLINT(bugprone-reserved-identifier)
                        __FindOfMutableClient <
                                __IterableType,
                                __ElementType,
                                __IteratorType,
                                __FromIterableType,
...
#endif // __CDS_SHARED_FIND_OF_MUTABLE_CLIENT_HPP__
