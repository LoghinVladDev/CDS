...
#ifndef __CDS_SHARED_GENERIC_MUTABLE_STATEMENTS_CLIENT_HPP__
#define __CDS_SHARED_GENERIC_MUTABLE_STATEMENTS_CLIENT_HPP__
    ...
    namespace experimental {    // NOLINT(modernize-concat-nested-namespaces)
        namespace __hidden {    // NOLINT(modernize-concat-nested-namespaces, bugprone-reserved-identifier)
            namespace __impl {  // NOLINT(bugprone-reserved-identifier)
                ...
                > class __GenericMutableStatementsClient {  // NOLINT(bugprone-reserved-identifier)
                ...
                template <
                        typename __IterableType,                // NOLINT(bugprone-reserved-identifier)
                        typename __ElementType                  // NOLINT(bugprone-reserved-identifier)
                > using __LocalGenericMutableStatementsClient = // NOLINT(bugprone-reserved-identifier)
                        __GenericMutableStatementsClient <
                                __IterableType,
                                __ElementType
                        >;
...
#endif // __CDS_SHARED_GENERIC_MUTABLE_STATEMENTS_CLIENT_HPP__
