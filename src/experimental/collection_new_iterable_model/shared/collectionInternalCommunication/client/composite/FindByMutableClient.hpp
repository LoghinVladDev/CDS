...
#ifndef __CDS_SHARED_FIND_BY_MUTABLE_CLIENT_HPP__
#define __CDS_SHARED_FIND_BY_MUTABLE_CLIENT_HPP__
    ...
    namespace experimental {    // NOLINT(modernize-concat-nested-namespaces)
        namespace __hidden {    // NOLINT(modernize-concat-nested-namespaces, bugprone-reserved-identifier)
            namespace __impl {  // NOLINT(bugprone-reserved-identifier)
                ...
                > class __FindByMutableClient {                 // NOLINT(bugprone-reserved-identifier)
                ...
                template <
                        ...
                        typename __ElementType,                 // NOLINT(bugprone-reserved-identifier)
                        typename __IteratorType                 // NOLINT(bugprone-reserved-identifier)
                > using __LocalFindByMutableClient =            // NOLINT(bugprone-reserved-identifier)
                        __FindByMutableClient <
                                __IterableType,
                                __ElementType,
                                __IteratorType
                        >;
...
#endif // __CDS_SHARED_FIND_BY_MUTABLE_CLIENT_HPP__
