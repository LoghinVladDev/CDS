    ...
    namespace experimental {    // NOLINT(modernize-concat-nested-namespaces)
        namespace __hidden {    // NOLINT(modernize-concat-nested-namespaces, bugprone-reserved-identifier)
            namespace __impl {  // NOLINT(bugprone-reserved-identifier)
                ...
                > class __LocalIteratorRemoveClient {       // NOLINT(bugprone-reserved-identifier)

                protected:
                    using __lirc_ElementType        = // NOLINT(bugprone-reserved-identifier)
                            __ElementType;
                ...
                protected:
                    auto remove (
                            __IteratorType const & iterator
                    ) noexcept -> bool;

                protected:
                    auto removeAll (
                            __IteratorType const * pIterators,
                            Size                   iteratorCount
                    ) noexcept -> Size;
                };
