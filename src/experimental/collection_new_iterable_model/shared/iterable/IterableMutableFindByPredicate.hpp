...
#ifndef __CDS_SHARED_ITERABLE_MUTABLE_FIND_BY_PREDICATE_HPP__
#define __CDS_SHARED_ITERABLE_MUTABLE_FIND_BY_PREDICATE_HPP__
    ...
    namespace experimental {    // NOLINT(modernize-concat-nested-namespaces)
        namespace __hidden {    // NOLINT(modernize-concat-nested-namespaces, bugprone-reserved-identifier)
            namespace __impl {  // NOLINT(bugprone-reserved-identifier)
                ...
                > class __IterableMutableFindByPredicate {      // NOLINT(bugprone-reserved-identifier)
...
#endif // __CDS_SHARED_ITERABLE_MUTABLE_FIND_BY_PREDICATE_HPP__
