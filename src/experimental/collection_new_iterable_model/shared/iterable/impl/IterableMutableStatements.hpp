...
#ifndef __CDS_SHARED_ITERABLE_MUTABLE_STATEMENTS_IMPL_HPP__
#define __CDS_SHARED_ITERABLE_MUTABLE_STATEMENTS_IMPL_HPP__
    ...
    namespace experimental {    // NOLINT(modernize-concat-nested-namespaces)
        namespace __hidden {    // NOLINT(modernize-concat-nested-namespaces, bugprone-reserved-identifier)
            namespace __impl {  // NOLINT(bugprone-reserved-identifier)
                ...
                > __CDS_OptimalInline auto __IterableMutableStatements <
                        __IterableType,
                        __ElementType
                > :: forEach (
...
#endif // __CDS_SHARED_ITERABLE_MUTABLE_STATEMENTS_IMPL_HPP__
