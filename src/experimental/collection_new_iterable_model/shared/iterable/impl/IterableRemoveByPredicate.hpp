...
#ifndef __CDS_SHARED_ITERABLE_REMOVE_BY_PREDICATE_IMPL_HPP__
#define __CDS_SHARED_ITERABLE_REMOVE_BY_PREDICATE_IMPL_HPP__
    ...
    namespace experimental {    // NOLINT(modernize-concat-nested-namespaces)
        namespace __hidden {    // NOLINT(modernize-concat-nested-namespaces, bugprone-reserved-identifier)
            namespace __impl {  // NOLINT(bugprone-reserved-identifier)
                ...
                > auto __IterableRemoveByPredicate <
                        __IterableType,
                        __ElementType
                > :: removeIf (
                        Size count,
...
#endif // __CDS_SHARED_ITERABLE_REMOVE_BY_PREDICATE_IMPL_HPP__
