...
#ifndef __CDS_SHARED_ITERABLE_MUTABLE_FIND_OF_IMPL_HPP__
#define __CDS_SHARED_ITERABLE_MUTABLE_FIND_OF_IMPL_HPP__
    ...
    namespace experimental {    // NOLINT(modernize-concat-nested-namespaces)
        namespace __hidden {    // NOLINT(modernize-concat-nested-namespaces, bugprone-reserved-identifier)
            namespace __impl {  // NOLINT(bugprone-reserved-identifier)
                ...
                > __CDS_OptimalInline auto __IterableMutableFindOf <
                        __IterableType,
                        __ElementType,
                        __IteratorType,
                        __FromIterableType,
...
#endif // __CDS_SHARED_ITERABLE_MUTABLE_FIND_OF_IMPL_HPP__
