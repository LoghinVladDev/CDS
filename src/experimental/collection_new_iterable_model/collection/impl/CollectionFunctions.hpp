...
#ifndef __CDS_EX_COLLECTION_FUNCTIONS_IMPL_HPP__
#define __CDS_EX_COLLECTION_FUNCTIONS_IMPL_HPP__ /* NOLINT(bugprone-reserved-identifier) */
...
#endif /* __CDS_EX_COLLECTION_FUNCTIONS_IMPL_HPP__ */
