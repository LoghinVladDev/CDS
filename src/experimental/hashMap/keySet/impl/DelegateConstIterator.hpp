...
#ifndef __CDS_EX_HASH_MAP_KEY_SET_PROXY_DELEGATE_CONST_ITERATOR_IMPL_HPP__
#define __CDS_EX_HASH_MAP_KEY_SET_PROXY_DELEGATE_CONST_ITERATOR_IMPL_HPP__
...
namespace cds { // NOLINT(modernize-concat-nested-namespaces)
    namespace experimental {
        ...
        __CDS_cpplang_ConstexprOverride auto HashMap < __KeyType, __ValueType, __Hasher > :: HashMapKeySetProxy :: HashMapKeySetProxyDelegateConstIterator :: value () const noexcept -> __KeyType const & {
            ...
            return ( * this->_iterator )._key.data();
        }
...
#endif // __CDS_EX_HASH_MAP_KEY_SET_PROXY_DELEGATE_CONST_ITERATOR_IMPL_HPP__
