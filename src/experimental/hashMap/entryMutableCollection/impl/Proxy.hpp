...
namespace cds { // NOLINT(modernize-concat-nested-namespaces)
    namespace experimental {
        ...
        template < typename __KeyType, typename __ValueType, typename __Hasher > // NOLINT(bugprone-reserved-identifier)
        __CDS_OptimalInline auto HashMap < __KeyType, __ValueType, __Hasher > :: HashMapEntryMutableCollectionProxy :: remove (
        ...
        template < typename __KeyType, typename __ValueType, typename __Hasher > // NOLINT(bugprone-reserved-identifier)
        __CDS_OptimalInline auto HashMap < __KeyType, __ValueType, __Hasher > :: HashMapEntryMutableCollectionProxy :: size () const noexcept -> Size {
