...
//    constexpr static StringLiteral in1Path = "../src/cdsIntern/tests/generic/collection/unordered/settings.json";
//    constexpr static StringLiteral in2Path = "../src/cdsIntern/tests/generic/collection/unordered/theme.json";
