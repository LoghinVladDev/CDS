...
bool SequenceTest::execute() noexcept {
    ...
    sList.forEach([& siHMap](String const & s){
    ...
    this->executeSubtest("Constructors/Destructors, Copy, Move, Clear tests", [&] {
        ...
        this->log("<Range> Ctor Resolution Test : '%s'", Sequence<Range>(r3).toString().cStr());
        this->log("<Range &> Ctor Resolution Test : '%s'", Sequence<Range const>(r2).toString().cStr());
        this->log("<Range const &> Ctor Resolution Test : '%s'", Sequence<Range>(r).toString().cStr());
        this->log("<Range &&> Ctor Resolution Test : '%s'", Sequence<Range>(Range(r)).toString().cStr());

        Array <float> a1 = fArray;
        Array<float> & a2 = fArray;
        Array<float> const & a3 = fArray;

        this->log("<Array> Ctor Resolution Test : '%s'", Sequence<Array<float>>(a1).toString().cStr());
        this->log("<Array &> Ctor Resolution Test : '%s'", Sequence<Array<float>>(a2).toString().cStr());
        this->log("<Array const &> Ctor Resolution Test : '%s'", Sequence<Array<float> const>(a3).toString().cStr());
        this->log("<Array &&> Ctor Resolution Test : '%s'", Sequence<Array<float>>(Array<float>(fArray)).toString().cStr());

        LinkedList<String> l1 = sList;
        LinkedList<String> & l2 = sList;
        LinkedList<String> const & l3 = sList;

        this->log("<List> Ctor Resolution Test : '%s'", Sequence<LinkedList<String>>(l1).toString().cStr());
        this->log("<List &> Ctor Resolution Test : '%s'", Sequence<LinkedList<String>>(l2).toString().cStr());
        this->log("<List const &> Ctor Resolution Test : '%s'", Sequence<LinkedList<String> const>(l3).toString().cStr());
        this->log("<List &&> Ctor Resolution Test : '%s'", Sequence<LinkedList<String>>(DoubleLinkedList<String>(sList)).toString().cStr());

        HashMap<String, int > m1 = siHMap;
        HashMap<String, int > & m2 = siHMap;
        HashMap<String, int > const & m3 = siHMap;

        this->log("<Map> Ctor Resolution Test : '%s'", Sequence<HashMap<String, int>>(m1).toString().cStr());
        this->log("<Map &> Ctor Resolution Test : '%s'", Sequence<HashMap<String, int>>(m2).toString().cStr());
        this->log("<Map const &> Ctor Resolution Test : '%s'", Sequence<HashMap<String, int> const>(m3).toString().cStr());
        this->log("<Map &&> Ctor Resolution Test : '%s'", Sequence<HashMap<String, int>>(HashMap<String, int>(siHMap)).toString().cStr());

        OrderedSet< int > o1 = intSet;
        OrderedSet< int > & o2 = intSet;
        OrderedSet< int > const & o3 = intSet;

        this->log("<OrderedSet> Ctor Resolution Test : '%s'", Sequence<OrderedSet<int>>(o1).toString().cStr());
        this->log("<OrderedSet &> Ctor Resolution Test : '%s'", Sequence<OrderedSet<int>>(o2).toString().cStr());
        this->log("<OrderedSet const &> Ctor Resolution Test : '%s'", Sequence<OrderedSet<int> const >(o3).toString().cStr());
        this->log("<OrderedSet &&> Ctor Resolution Test : '%s'", Sequence<OrderedSet<int>>(OrderedSet<int>(intSet)).toString().cStr());

        UnorderedSet< uint32 > u1 = uintUSet;
        UnorderedSet< uint32 > & u2 = uintUSet;
        UnorderedSet< uint32 > const & u3 = uintUSet;

        this->log("<UnorderedSet> Ctor Resolution Test : '%s'", Sequence<UnorderedSet<uint32>>(u1).toString().cStr());
        this->log("<UnorderedSet &> Ctor Resolution Test : '%s'", Sequence<UnorderedSet<uint32>>(u2).toString().cStr());
        this->log("<UnorderedSet const &> Ctor Resolution Test : '%s'", Sequence<UnorderedSet<uint32> const>(u3).toString().cStr());
        this->log("<UnorderedSet &&> Ctor Resolution Test : '%s'", Sequence<UnorderedSet<uint32>>(UnorderedSet<uint32>(uintUSet)).toString().cStr());
    });
    ...
    this->executeSubtest("Transformational Utilities", [&]{
        ...
        auto filterIsInstanceTest = [&]{
            ...
            animals.forEach([](Animal * p){ delete p; });
        ...
        auto filterNotNullTest = [&] {
            ...
            numbers.forEach([](Int * p){ delete p; });
