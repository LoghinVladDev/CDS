...
/* SetTestGroup-MemberFunctions-CPP11 : STS-00100-MF-CPP11. Tests STC-00101 to STC-001xx */
template <
...
> auto setTestGroupMemberFunctions (
    ...
    /* SetTestGroup-MemberFunctions-toString-CPP11 : STC-00101-MF-toString-CPP11 */
    ...
    if ( asString != expectedToString ) {
        pTestLib->logError ( "'STC-00101-MF-toString-CPP11' failed" );
        return false;
    } else {
        pTestLib->logOK ( "'STC-00101-MF-toString-CPP11' OK" );
    }

    /* SetTestGroup-MemberFunctions-removeScen1-CPP11 : STC-00103-MF-removeScen1-CPP11 */
    bool resultRemove1 = collection.remove ( remove1 );
    if ( resultRemove1 != remove1Success || ! equiv ( collection, remove1Equiv ) ) {
        pTestLib->logError ( "'STC-00103-MF-removeScen1-CPP11' failed" );
        return false;
    } else {
        pTestLib->logOK ( "'STC-00103-MF-removeScen1-CPP11' OK" );
    }

    /* SetTestGroup-MemberFunctions-removeScen2-CPP11 : STC-00104-MF-removeScen2-CPP11 */
    bool resultRemove2 = collection.remove ( remove2 );
    if ( resultRemove2 != remove2Success || ! equiv ( collection, remove2Equiv ) ) {
        pTestLib->logError ( "'STC-00104-MF-removeScen2-CPP11' failed" );
        return false;
    } else {
        pTestLib->logOK ( "'STC-00104-MF-removeScen2-CPP11' OK" );
    }

    /* SetTestGroup-MemberFunctions-removeScen3-CPP11 : STC-00105-MF-removeScen3-CPP11 */
    bool resultRemove3 = collection.remove ( remove3 );
    if ( resultRemove3 != remove3Success || ! equiv ( collection, remove3Equiv ) ) {
        pTestLib->logError ( "'STC-00105-MF-removeScen3-CPP11' failed" );
        return false;
    } else {
        pTestLib->logOK ( "'STC-00105-MF-removeScen3-CPP11' OK" );
    }

    /* SetTestGroup-MemberFunctions-removeScen4-CPP11 : STC-00106-MF-removeScen4-CPP11 */
    bool resultRemove4 = collection.remove ( remove4 );
    if ( resultRemove4 != remove4Success || ! equiv ( collection, remove4Equiv ) ) {
        pTestLib->logError ( "'STC-00106-MF-removeScen4-CPP11' failed" );
        return false;
    } else {
        pTestLib->logOK ( "'STC-00106-MF-removeScen4-CPP11' OK" );
    }

    /* SetTestGroup-MemberFunctions-removeScen5-CPP11 : STC-00107-MF-removeScen5-CPP11 */
    bool resultRemove5 = collection.remove ( remove5 );
    if ( resultRemove5 != remove5Success || ! equiv ( collection, remove5Equiv ) ) {
        pTestLib->logError ( "'STC-00107-MF-removeScen5-CPP11' failed" );
        return false;
    } else {
        pTestLib->logOK ( "'STC-00107-MF-removeScen5-CPP11' OK" );
    }

    /* SetTestGroup-MemberFunctions-clear-CPP11 : STC-00102-MF-clear-CPP11 */
    collection.clear();
    ...
    if ( asString.length() > 2ULL ) {
        pTestLib->logError( "'STC-00102-MF-clear-CPP11 - toString' failed" );
        return false;
    } else {
        pTestLib->logOK ( "'STC-00102-MF-clear-CPP11' OK" );
    }
...
/* SetTestSuite-CPP11 : STS-00001-CPP11 */
auto SetTest :: execute () noexcept -> bool {
    ...
    this->executeSubtest ( "SetTestGroup-MemberUniqueness-CPP11 : STG-00002-MU-CPP11 : IntHashSet", [& allOk, this] {
        ...
        if ( allOk && ! status ) {
            this->logError ( "'STC-00003-MU-SetDuplicateProperty-CPP11' failed" );
            allOk = false;
        }

        if ( allOk ) {
            this->logOK( "'STC-00003-MU-SetDuplicateProperty-CPP11' OK" );
        }
    });
    this->executeSubtest ( "SetTestGroup-MemberUniqueness-CPP11 : STG-00002-MU-CPP11 : IntTreeSet", [& allOk, this] {
    ...
    this->executeSubtest ( "SetTestGroup-MemberUniqueness-CPP11 : STG-00002-MU-CPP11 : StringTreeSet", [& allOk, this] {
    ...
    this->executeSubtest ( "SetTestGroup-FindUnique-CPP11 : STG-00050-FU-CPP11 : IntHashSet", [& allOk, this] {
        ...
        for ( auto e : { -5, -4, -3, -2, -1, 0, 6, 7, 8, 9 } ) {
            ...
            if ( it != underTest.end() ) {
                this->logError ( "'STC-00051-FU-FindUniqueNotIn-CPP11' failed" );
                allOk = false;
                break;
            }
        }
        ...
        if ( allOk ) {
            this->logOK( "'STC-00051-FU-FindUniqueNotIn-CPP11' OK" );
        }

        /* SetTestCase-FindUnique-FindUniqueIn-CPP11 : STC-00052-MU-FindUniqueIn-CPP11 */

        for ( auto e : { 1, 2, 3, 4, 5 } ) {
            auto it = underTest.find ( e );
            if ( ! it.valid() || it == underTest.end() || ( * it != e ) ) {
                this->logError ( "'STC-00052-FU-FindUniqueIn-CPP11' failed" );
                allOk = false;
                break;
            }
        }
        ...
        if ( allOk ) {
            this->logOK( "'STC-00052-FU-FindUniqueIn-CPP11' OK" );
        }
    });
    this->executeSubtest ( "SetTestGroup-FindUnique-CPP11 : STG-00050-FU-CPP11 : IntTreeSet", [& allOk, this] {
    ...
    this->executeSubtest ( "SetTestGroup-FindUnique-CPP11 : STG-00050-FU-CPP11 : StringTreeSet", [& allOk, this] {
    ...
    this->executeSubtest ( "SetTestGroup-MemberFunctions-CPP11 : STG-00100-MF-CPP11 : IntTreeSet", [& allOk, this] {
    ...
    this->executeSubtest ( "SetTestGroup-MemberFunctions-CPP11 : STG-00100-MF-CPP11 : StringTreeSet", [& allOk, this] {
