...
#ifndef __CDS_LINKED_LIST_DELEGATE_CONST_ITERATOR_IMPL_HPP__
#define __CDS_LINKED_LIST_DELEGATE_CONST_ITERATOR_IMPL_HPP__
...
#endif // __CDS_LINKED_LIST_DELEGATE_CONST_ITERATOR_IMPL_HPP__
