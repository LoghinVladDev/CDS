...
#ifndef __CDS_LINKED_LIST_DELEGATE_CONST_ITERATOR_HPP__
#define __CDS_LINKED_LIST_DELEGATE_CONST_ITERATOR_HPP__
...
namespace cds {
    ...
    public:
        __CDS_cpplang_ConstexprDestructor ~LinkedListDelegateConstIterator () noexcept override = default;
    ...
    public:
        __CDS_NoDiscard auto copy () const noexcept -> LinkedListDelegateConstIterator * override;
    };

}

#endif // __CDS_LINKED_LIST_DELEGATE_CONST_ITERATOR_HPP__
