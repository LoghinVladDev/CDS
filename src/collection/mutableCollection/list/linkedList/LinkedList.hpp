...
#define __CDS_LINKED_LIST_HPP__
...
namespace cds {
    ...
    private:
        using NodeData = __hidden :: __impl :: __allocation :: __RawContainer < __ElementType >;
    ...
    public:
        template < typename __IteratorType, meta :: EnableIf < cds :: meta :: isIterator < __IteratorType > () > = 0 > // NOLINT(bugprone-reserved-identifier)
        LinkedList (
