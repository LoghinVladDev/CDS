...
#ifndef __CDS_ARRAY_HPP__
#define __CDS_ARRAY_HPP__ /* NOLINT(bugprone-reserved-identifier) */
...
namespace cds {
    ...
    private:
        friend __hidden :: __impl :: __ListServer < Array < __ElementType >, __ElementType >; /* NOLINT(bugprone-reserved-identifier) */
