...
public:
  ...
  using MutableCollectionBase::size;
...
protected:
  ...
  /// @test Suite: STS-00001, Group: All, Test Cases: All
  /// @protected
  constexpr List (List const& list) noexcept;
...
#include "../../../shared/iterableInternalCommunication/client/composite/impl/IndicesCompositeClientImpl.hpp"
