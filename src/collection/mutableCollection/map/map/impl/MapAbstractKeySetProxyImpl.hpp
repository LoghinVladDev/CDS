...
__CDS_MaybeUnused constexpr Map <__KeyType, __ValueType>::AbstractKeySetProxy::AbstractKeySetProxy (
...
template <typename __KeyType, typename __ValueType> // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
__CDS_cpplang_VirtualConstexpr auto Map <__KeyType, __ValueType>::AbstractKeySetProxy::size () const noexcept -> Size {
  return map()->size();
}


template <typename __KeyType, typename __ValueType> // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
__CDS_OptimalInline auto Map <__KeyType, __ValueType>::AbstractKeySetProxy::__newAddress (
