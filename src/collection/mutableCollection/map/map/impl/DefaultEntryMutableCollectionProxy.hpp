...
#ifndef __CDS_MAP_DEFAULT_ENTRY_MUTABLE_COLLECTION_PROXY_IMPL_HPP__
#define __CDS_MAP_DEFAULT_ENTRY_MUTABLE_COLLECTION_PROXY_IMPL_HPP__
...
#endif // __CDS_MAP_DEFAULT_ENTRY_MUTABLE_COLLECTION_PROXY_IMPL_HPP__
