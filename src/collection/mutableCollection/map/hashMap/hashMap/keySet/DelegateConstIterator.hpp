...
#ifndef __CDS_HASH_MAP_KEY_SET_PROXY_DELEGATE_CONST_ITERATOR_HPP__
#define __CDS_HASH_MAP_KEY_SET_PROXY_DELEGATE_CONST_ITERATOR_HPP__
...
#endif // __CDS_HASH_MAP_KEY_SET_PROXY_DELEGATE_CONST_ITERATOR_HPP__
