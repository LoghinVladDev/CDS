            ...
            template <
                    ...
                    typename __LinkedHashMap =                          /* NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp) */
                            LinkedHashMap <
                                    ...
                                    __Hasher
                            >
            > using __LinkedHashMapEntryProxyFindOfIterableClient =     /* NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp) */
            ...
            template <
                    ...
                    typename __LinkedHashMap =                              /* NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp) */
                            LinkedHashMap <
                                    ...
                                    __Hasher
                            >
            > using __LinkedHashMapEntryProxyFindOfConstIterableClient =    /* NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp) */
            ...
            template <
                    ...
                    typename __LinkedHashMap =                          /* NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp) */
                            LinkedHashMap <
                                    ...
                                    __Hasher
                            >
            > using __LinkedHashMapEntryProxyRemoveOfIterableClient =   /* NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp) */
            ...
            template <
                    ...
                    typename __LinkedHashMap =                          /* NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp) */
                            LinkedHashMap <
                                    ...
                                    __Hasher
                            >
            > using __LinkedHashMapEntryProxyContainsOfIterableClient = /* NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp) */
