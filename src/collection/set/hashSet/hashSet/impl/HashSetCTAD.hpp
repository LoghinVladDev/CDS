...
> HashSet (std::initializer_list <__ElementType>) -> HashSet <__ElementType, __Hasher>;

template <
    typename __ElementType,                                                             // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
    typename __Hasher = cds::WrapperHasher <__ElementType, Hash <__ElementType>>  // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
> HashSet (__Hasher, std::initializer_list <__ElementType>) -> HashSet <__ElementType, __Hasher>;
