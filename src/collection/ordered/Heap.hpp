...
namespace cds {
    ...
    public:
        ...
        __CDS_NoDiscard auto operator == (Heap const &) const noexcept -> bool;
        __CDS_NoDiscard auto equals ( Object const & ) const noexcept -> bool final;
        ...
        __CDS_NoDiscard inline auto index ( T & obj ) noexcept -> Index override {
            return this->_elements.index( obj );
        }

        __CDS_NoDiscard inline auto index ( T const & obj ) const noexcept -> Index override {
            return this->_elements.index( obj );
        }

        __CDS_NoDiscard inline auto get (Index i) noexcept (false) -> T & override {
            return this->_elements.get(i);
        }

        __CDS_NoDiscard inline auto get (Index i) const noexcept (false) -> T const & override {
            return this->_elements.get(i);
        }
        ...
        __CDS_NoDiscard virtual inline auto sub ( Index from, Index to ) const noexcept (false) -> Array < T > {
