...
namespace cds {                 /* NOLINT(modernize-concat-nested-namespaces) */
    ...
    namespace __hidden {    /* NOLINT(modernize-concat-nested-namespaces, bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp) */
        namespace __impl {  /* NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp) */
             ...
             * @tparam __ElementType the type of the value given and of the values enclosed in the iterable
            ...
            /**
             * @typedef Alias used by Iterable to extend the Communication Channel object
             * @tparam __ElementType the type of the elements enclosed in the extending Iterable
             * @namespace cds :: __hidden :: __impl
             * @internal library-private
             */
            template < typename __ElementType >     /* NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp) */
            using __IterableCommunicationChannel =  /* NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp) */
            ...
            /**
             * @typedef Alias used by Iterable to implement the Delegate Forward Const Iterable Client
             * @tparam __ElementType the type of the elements enclosed in the extending Iterable
             * @namespace cds :: __hidden :: __impl
             * @internal library-private
             */
            template < typename __ElementType >                     /* NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp) */
            using __IterableDelegateForwardConstIterableClient =    /* NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp) */
            ...
            /**
             * @typedef Alias used by Iterable to implement the Contains Of Iterable Client
             * @tparam __ElementType the type of the elements enclosed in the extending Iterable
             * @namespace cds :: __hidden :: __impl
             * @internal library-private
             */
            template < typename __ElementType >         /* NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp) */
            using __IterableContainsOfIterableClient =  /* NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp) */
            ...
            /**
             * @typedef Alias used by Iterable to implement the Contains of Initializer List Client
             * @tparam __ElementType the type of the elements enclosed in the extending Iterable
             * @namespace cds :: __hidden :: __impl
             * @internal library-private
             */
            template < typename __ElementType >                 /* NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp) */
            using __IterableContainsOfInitializerListClient =   /* NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp) */
                    __ContainsOfCompositeClient <
                            cds :: Iterable < __ElementType >,
                            __ElementType,
            ...
            /**
             * @typedef Alias used by Iterable to implement the Find Of Immutable Iterable Client
             * @tparam __ElementType the type of the elements enclosed in the extending Iterable
             * @namespace cds :: __hidden :: __impl
             * @internal library-private
             */
            template < typename __ElementType >         /* NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp) */
            using __IterableFindOfIterableClient =  /* NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp) */
            ...
            /**
             * @typedef Alias used by Iterable to implement the Find Of Immutable Initializer List Client
             * @tparam __ElementType the type of the elements enclosed in the extending Iterable
             * @namespace cds :: __hidden :: __impl
             * @internal library-private
             */
            template < typename __ElementType >             /* NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp) */
            using __IterableFindOfInitializerListClient = /* NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp) */
                    __FindOfImmutableCompositeClient <
                            cds :: Iterable < __ElementType >,
                            __ElementType,
                            typename __IterableDelegateForwardConstIterableClient < __ElementType > :: ConstIterator,
            ...
            /**
             * @typedef Alias used by Iterable to implement the Find by Immutable Predicate Client
             * @tparam __ElementType the type of the elements enclosed in the extending Iterable
             * @namespace cds :: __hidden :: __impl
             * @internal library-private
             */
            template < typename __ElementType > /* NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp) */
            using __IterableFindByClient =    /* NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp) */
            ...
            /**
             * @typedef Alias used by Iterable to implement the Generic Immutable Statements Client
             * @tparam __ElementType the type of the elements enclosed in the extending Iterable
             * @namespace cds :: __hidden :: __impl
             * @internal library-private
             */
            template < typename __ElementType >         /* NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp) */
            using __IterableGenericStatementsClient = /* NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp) */
