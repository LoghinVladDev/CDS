...
#ifndef __CDS_SHARED_RED_BLACK_TREE_ITERATOR_HPP__
#define __CDS_SHARED_RED_BLACK_TREE_ITERATOR_HPP__ /* NOLINT(bugprone-reserved-identifier) */
...
#endif /* __CDS_SHARED_RED_BLACK_TREE_ITERATOR_HPP__ */
