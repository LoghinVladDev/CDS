...
#ifndef __CDS_SHARED_CONTAINS_OF_COMPOSITE_CLIENT_IMPL_HPP__
#define __CDS_SHARED_CONTAINS_OF_COMPOSITE_CLIENT_IMPL_HPP__ /* NOLINT(bugprone-reserved-identifier) */
