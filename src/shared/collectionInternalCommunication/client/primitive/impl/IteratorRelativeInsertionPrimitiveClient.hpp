    ...
    namespace __hidden {    /* NOLINT(modernize-concat-nested-namespaces, bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp) */
        namespace __impl {  /* NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp) */
            ...
            > :: emplaceBefore (
                ...
                auto const pNewLocation = reinterpret_cast < __ReceiverNewBeforeHandlerType > ( pReceiver->__cicch_obtainGenericHandler ( __CollectionInternalRequestType :: __cirt_newBeforeAddress ) ) (
                        pReceiver,
            ...
            > :: emplaceAfter (
                ...
                auto const pNewLocation = reinterpret_cast < __ReceiverNewAfterHandlerType > ( pReceiver->__cicch_obtainGenericHandler ( __CollectionInternalRequestType :: __cirt_newAfterAddress ) ) (
                        pReceiver,
                        iterator._pDelegate->iterator()
                );
            ...
            > :: insertAllBefore (
                ...
                auto const allocationStatus = reinterpret_cast < __ReceiverNewBeforeArrayHandlerType > ( pReceiver->__cicch_obtainGenericHandler ( __CollectionInternalRequestType :: __cirt_newBeforeAddressArray ) ) (
                        pReceiver,
                        iterator._pDelegate->iterator(),
                        parameterCount,
                        ppElements
            ...
            > :: insertAllAfter (
                ...
                auto const allocationStatus = reinterpret_cast < __ReceiverNewAfterArrayHandlerType > ( pReceiver->__cicch_obtainGenericHandler ( __CollectionInternalRequestType :: __cirt_newAfterAddressArray ) ) (
                        pReceiver,
                        iterator._pDelegate->iterator(),
                        parameterCount,
                        ppElements
