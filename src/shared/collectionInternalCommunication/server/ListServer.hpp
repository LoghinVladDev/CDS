...
#define __CDS_SHARED_LIST_SERVER_HPP__ /* NOLINT(bugprone-reserved-identifier) */
    ...
    namespace __hidden {    /* NOLINT(modernize-concat-nested-namespaces, bugprone-reserved-identifier) */
        namespace __impl {  /* NOLINT(bugprone-reserved-identifier) */
            ...
            protected:
                 ...
                 * @protected
                 */
                __CDS_NoDiscard constexpr auto __ls_handlers () const noexcept -> __GenericHandler const *; /* NOLINT(bugprone-reserved-identifier) */
            ...
            protected:
                 ...
                 * @protected
                 */
                __CDS_NoDiscard constexpr auto __ls_constHandlers () const noexcept -> __GenericConstHandler const *;   /* NOLINT(bugprone-reserved-identifier) */
            };
