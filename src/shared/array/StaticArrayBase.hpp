...
namespace __impl {  // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
  ...
  constexpr static auto __staticArrayMemoryContainerStackLimit (Size limit) noexcept -> bool {
...
template <
   ...
   public __IterableServerDispatcher <
       __ServerType,
       __StaticArrayBase < __Element, __size, __equals, __MemoryContainer >,
       __Element,
       ForwardAddressIterator < __Element const >,
       & __StaticArrayBase < __Element, __size, __equals, __MemoryContainer >::__sab_cbegin,
       & __StaticArrayBase < __Element, __size, __equals, __MemoryContainer >::__sab_cend
       > {
