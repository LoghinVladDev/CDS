...
protected:
  ...
  /// \typedef alias for Abstract Const Iterator type
  /// \private
  using AbstractConstIterator  = __AbstractDelegateWrapperIterator <__Element const>;
  ...
  > auto insertBefore (AbstractConstIterator const& iterator, ElementType const& element) noexcept(false) -> bool;
  ...
  > auto insertBefore (AbstractConstIterator const& iterator, ElementType&& element) noexcept(false) -> bool;
  ...
  template <
      typename __TElementType = ElementType,    // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
      cds::meta::EnableIf <cds::meta::IsCopyConstructible <__TElementType>::value> = 0
  > auto insertAfter (AbstractConstIterator const& iterator, ElementType const& element) noexcept(false) -> bool;
  ...
  template <
      typename __TElementType = ElementType,    // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
      cds::meta::EnableIf <cds::meta::IsMoveConstructible <__TElementType>::value> = 0
  > auto insertAfter (AbstractConstIterator const& iterator, ElementType&& element) noexcept(false) -> bool;
  ...
  auto emplaceBefore (AbstractConstIterator const& iterator, __Arguments&&... parameters) noexcept(false) -> bool;
  ...
  /// \public
  template <typename...__Arguments> // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
  auto emplaceAfter (AbstractConstIterator const& iterator, __Arguments&&... parameters) noexcept(false) -> bool;
  ...
  /// \public
  template <typename...__Arguments> // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
  auto insertAllBefore (AbstractConstIterator const& iterator, __Arguments&&... values) noexcept(false) -> bool;
  ...
  /// \public
  template <typename...__Arguments> // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
  auto insertAllAfter (AbstractConstIterator const& iterator, __Arguments&&... values) noexcept(false) -> bool;
  ...
  > auto insertAllOfBefore (AbstractConstIterator const& iterator, __IterableType const& iterable) noexcept(false) -> bool;
  ...
  template <
      ...
      cds::meta::EnableIf <cds::meta::IsCopyConstructible <__TElementType>::value> = 0
  > auto insertAllOfBefore (AbstractConstIterator const& iterator, std::initializer_list <__Element> const& list) noexcept(false) -> bool;
  ...
  template <
      typename __IterableType, // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
      cds::meta::EnableIf <meta::__IterableSizeAvailable <__IterableType>::value> = 0
  > auto insertAllOfAfter (AbstractConstIterator const& iterator, __IterableType const& iterable) noexcept(false) -> bool;
  ...
  template <
      typename __TElementType = __Element, // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
      cds::meta::EnableIf <cds::meta::IsCopyConstructible <__TElementType>::value> = 0
  > auto insertAllOfAfter (AbstractConstIterator const& iterator, std::initializer_list <__Element> const& list) noexcept(false) -> bool;
...
protected:
  ...
  /// \typedef alias for Const Iterator type
  /// \private
  ...
  template <
      typename __TElementType = ElementType,    // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
      cds::meta::EnableIf <cds::meta::IsCopyConstructible <__TElementType>::value> = 0
  > auto insertBefore (ConstIterator const& iterator, ElementType const& element) noexcept(false) -> bool;
  ...
  template <
      typename __TElementType = ElementType,    // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
      cds::meta::EnableIf <cds::meta::IsMoveConstructible <__TElementType>::value> = 0
  > auto insertBefore (ConstIterator const& iterator, ElementType&& element) noexcept(false) -> bool;
  ...
  template <
      typename __TElementType = ElementType,    // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
      cds::meta::EnableIf <cds::meta::IsCopyConstructible <__TElementType>::value> = 0
  > auto insertAfter (ConstIterator const& iterator, ElementType const& element) noexcept(false) -> bool;
  ...
  template <
      typename __TElementType = ElementType,    // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
      cds::meta::EnableIf <cds::meta::IsMoveConstructible <__TElementType>::value> = 0
  > auto insertAfter (ConstIterator const& iterator, ElementType&& element) noexcept(false) -> bool;
  ...
  /// \public
  template <typename...__Arguments> // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
  auto emplaceBefore (ConstIterator const& iterator, __Arguments&& ... parameters) noexcept(false) -> bool;
  ...
  /// \public
  template <typename...__Arguments> // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
  auto emplaceAfter (ConstIterator const& iterator, __Arguments&&... parameters) noexcept(false) -> bool;
  ...
  /// \public
  template <typename...__Arguments> // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
  auto insertAllBefore (ConstIterator const& iterator, __Arguments&&... values) noexcept(false) -> bool;
  ...
  /// \public
  template <typename...__Arguments> // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
  auto insertAllAfter (ConstIterator const& iterator, __Arguments&&... values) noexcept(false) -> bool;
  ...
  template <
      typename __IterableType, // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
      cds::meta::EnableIf <meta::__IterableSizeAvailable <__IterableType>::value> = 0
  > auto insertAllOfBefore (ConstIterator const& iterator, __IterableType const& iterable) noexcept(false) -> bool;
  ...
  template <
      typename __TElementType = __Element, // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
      cds::meta::EnableIf <cds::meta::IsCopyConstructible <__TElementType>::value> = 0
  > auto insertAllOfBefore (ConstIterator const& iterator, std::initializer_list <__Element> const& list) noexcept(false) -> bool;
  ...
  template <
      typename __IterableType, // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
      cds::meta::EnableIf <meta::__IterableSizeAvailable <__IterableType>::value> = 0
  > auto insertAllOfAfter (ConstIterator const& iterator, __IterableType const& iterable) noexcept(false) -> bool;
  ...
  template <
      typename __TElementType = __Element, // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
      cds::meta::EnableIf <cds::meta::IsCopyConstructible <__TElementType>::value> = 0
  > auto insertAllOfAfter (ConstIterator const& iterator, std::initializer_list <__Element> const& list) noexcept(false) -> bool;
