...
///
/// \test Suite: STS-00001, Group: STG-00050-FU, Test Cases: All
...
public:
  ...
  using ConstIterator =
      cds::meta::Conditional <
          __bidirectional,
          __BidirectionalDelegateWrapperIterator <__Element const>,
          __ForwardDelegateWrapperIterator <__Element const>
      >;
  ...
  /// \test Suite: STS-00001, Group: STG-00050-FU, Test Cases: All
  /// \public
  __CDS_NoDiscard auto find (__Key const& key) const noexcept(false) -> ConstIterator;
};
...
public:
  ...
  /// \test Suite: TBA, Group: TBA, Test Cases: TBA
  /// \public
  __CDS_NoDiscard auto find (__Key const& key) const noexcept -> ConstIterator;
};
} // namespace __impl
} // namespace __hidden
} // namespace cds
