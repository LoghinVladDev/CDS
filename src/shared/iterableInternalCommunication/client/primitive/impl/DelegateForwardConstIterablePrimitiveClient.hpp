        ...
        namespace __impl {  /* NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp) */
            ...
            > :: cbegin () const noexcept -> ConstIterator {
                ...
                return ConstIterator (
                        pReceiver,
                        reinterpret_cast < __ReceiverBeginHandlerType > ( pReceiver->__iicch_obtainGenericConstHandler ( __IterableInternalRequestType :: __iirt_begin ) ) ( pReceiver )
                );
            }
            ...
            > :: cend () const noexcept -> ConstIterator {
                ...
                return ConstIterator (
                        pReceiver,
                        reinterpret_cast < __ReceiverEndHandlerType > ( pReceiver->__iicch_obtainGenericConstHandler ( __IterableInternalRequestType :: __iirt_end ) ) ( pReceiver )
                );
            }
