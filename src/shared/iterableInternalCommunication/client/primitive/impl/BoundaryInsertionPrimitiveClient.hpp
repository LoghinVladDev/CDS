                        ...
                        (
                                pReceiver ->* reinterpret_cast < __ReceiverNewFrontHandlerType > (
                                        pReceiver->__iicch_obtainGenericHandler (
                                                __IterableInternalRequestType :: __iirt_newFrontAddress
                                        )
                                )
                        ) ()
                ) __ElementType (
                ...
                return * new (
                        (
                                pReceiver ->* reinterpret_cast < __ReceiverNewBackHandlerType > (
                                        pReceiver->__iicch_obtainGenericHandler (
                                                __IterableInternalRequestType :: __iirt_newBackAddress
                                        )
                                )
                        ) ()
                ) __ElementType (
            ...
            > :: pushFrontAll (
                ...
                (
                        pReceiver ->* reinterpret_cast < __ReceiverNewFrontArrayHandlerType > (
                                pReceiver->__iicch_obtainGenericHandler (
                                        __IterableInternalRequestType :: __iirt_newFrontAddressArray
                                )
                        )
                ) (
                        parameterCount,
            ...
            > :: pushBackAll (
                ...
                (
                        pReceiver ->* reinterpret_cast < __ReceiverNewBackArrayHandlerType > (
                                pReceiver->__iicch_obtainGenericHandler (
                                        __IterableInternalRequestType :: __iirt_newBackAddressArray
                                )
                        )
                ) (
                        parameterCount,
