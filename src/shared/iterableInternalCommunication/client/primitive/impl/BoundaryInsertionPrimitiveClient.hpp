    ...
    namespace __hidden {    /* NOLINT(modernize-concat-nested-namespaces, bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp) */
        namespace __impl {  /* NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp) */
            ...
            > :: emplaceFront (
                ...
                return * new (
                        reinterpret_cast < __ReceiverNewFrontHandlerType > ( pReceiver->__iicch_obtainGenericHandler ( __IterableInternalRequestType :: __iirt_newFrontAddress ) ) (
                                pReceiver
                        )
                ) __ElementType (
            ...
            > :: emplaceBack (
                 ...
                 * forward the received parameters to the emplacement new operator */
                return * new (
                        reinterpret_cast < __ReceiverNewBackHandlerType > ( pReceiver->__iicch_obtainGenericHandler ( __IterableInternalRequestType :: __iirt_newBackAddress ) ) (
                                pReceiver
                        )
                ) __ElementType (
                        std :: forward < __EmplaceArgumentTypes > ( parameters ) ...
            ...
            > :: pushBackAll (
                ...
                reinterpret_cast < __ReceiverNewBackArrayHandlerType > ( pReceiver->__iicch_obtainGenericHandler ( __IterableInternalRequestType :: __iirt_newBackAddressArray ) ) (
                        pReceiver,
                        parameterCount,
                        ppElements
                );
