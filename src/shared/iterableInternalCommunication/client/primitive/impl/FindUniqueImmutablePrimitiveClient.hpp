        ...
        namespace __impl {  /* NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp) */
            ...
            > :: find (
                ...
                return ConstIterator (
                        pReceiver,
                        reinterpret_cast < __ReceiverFindConstHandlerType > ( pReceiver->__iicch_obtainGenericConstHandler ( __IterableInternalRequestType :: __iirt_findConst ) ) ( pReceiver, key )
                );
            }
