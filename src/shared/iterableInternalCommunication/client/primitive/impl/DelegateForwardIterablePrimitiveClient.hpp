    ...
    namespace __hidden {    /* NOLINT(modernize-concat-nested-namespaces, bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp) */
        namespace __impl {  /* NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp) */
            ...
            > :: begin () noexcept -> Iterator {
                ...
                return Iterator (
                        pReceiver,
                        reinterpret_cast < __ReceiverBeginHandlerType > ( pReceiver->__iicch_obtainGenericHandler ( __IterableInternalRequestType :: __iirt_begin ) ) ( pReceiver )
                );
            }
            ...
            > :: end () noexcept -> Iterator {
                ...
                return Iterator (
                        pReceiver,
                        reinterpret_cast < __ReceiverEndHandlerType > ( pReceiver->__iicch_obtainGenericHandler ( __IterableInternalRequestType :: __iirt_end ) ) ( pReceiver )
                );
            }
