...
#ifndef __CDS_SHARED_ITERATOR_RELATIVE_INSERTION_PRIMITIVE_CLIENT_HPP__ // NOLINT(llvm-header-guard)
#define __CDS_SHARED_ITERATOR_RELATIVE_INSERTION_PRIMITIVE_CLIENT_HPP__ // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
#pragma once
...
/// \tparam __ReturnType is the type returned by the singular insertion functions
///
...
protected:
  ...
  /// \typedef alias for Abstract Iterator type
  /// \private
  using AbstractIterator  = __AbstractDelegateWrapperIterator <__Element>;
  ...
  ///
  /// \test Suite: LTS-00001, Group: LTG-00400-RI, Test Cases: {
  ...
  template <
      ...
      cds::meta::EnableIf <
          cds::meta::IsCopyConstructible <__TElementType>::value
      > = 0
  > auto insertBefore (AbstractIterator const& iterator, ElementType const& element) noexcept(false) -> bool;
  ...
  > auto insertBefore (AbstractIterator const& iterator, ElementType&& element) noexcept(false) -> bool;
  ...
  > auto insertAfter (AbstractIterator const& iterator, ElementType const& element) noexcept(false) -> bool;
  ...
  template <
      typename __TElementType = ElementType,    // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
      cds::meta::EnableIf <cds::meta::IsMoveConstructible <__TElementType>::value> = 0
  > auto insertAfter (AbstractIterator const& iterator, ElementType&& element) noexcept(false) -> bool;

  /// \brief Function used to create a new element before a given iterator by emplacement
  /// \tparam __Arguments is the pack of argument types passed to the constructor
  /// \param [in] iterator : AbstractIterator cref = Constant Reference to the iterator to insert before
  /// \param [in] parameters : __Arguments fref ... = Pack of forwarding references passed to the constructor
  ...
  auto emplaceBefore (AbstractIterator const& iterator, __Arguments&&... parameters) noexcept(false) -> bool;
  ...
  /// \public
  template <typename...__Arguments> // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
  auto emplaceAfter (AbstractIterator const& iterator, __Arguments&&... parameters) noexcept(false) -> bool;
  ...
  /// \public
  template <typename...__Arguments> // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
  auto insertAllBefore (AbstractIterator const& iterator, __Arguments&&... values) noexcept(false) -> bool;
  ...
  /// \public
  template <typename...__Arguments> // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
  auto insertAllAfter (AbstractIterator const& iterator, __Arguments&&... values) noexcept(false) -> bool;
  ...
  /// \tparam __IterableType is the type of iterable given as parameter
  /// \param [in] iterator : AbstractIterator cref = Constant Reference to the iterator to insert before
  ...
  template <
      ...
      cds::meta::EnableIf <meta::__IterableSizeAvailable <__IterableType>::value> = 0
  > auto insertAllOfBefore (AbstractIterator const& iterator, __IterableType const& iterable) noexcept(false) -> bool;
  ...
  template <
      ...
      cds::meta::EnableIf <cds::meta::IsCopyConstructible <__TElementType>::value> = 0
  > auto insertAllOfBefore (AbstractIterator const& iterator, std::initializer_list <__Element> const& list) noexcept(false) -> bool;
  ...
  template <
      typename __IterableType, // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
      cds::meta::EnableIf <meta::__IterableSizeAvailable <__IterableType>::value> = 0
  > auto insertAllOfAfter (AbstractIterator const& iterator, __IterableType const& iterable) noexcept(false) -> bool;
  ...
  template <
      typename __TElementType = __Element, // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
      cds::meta::EnableIf <cds::meta::IsCopyConstructible <__TElementType>::value> = 0
  > auto insertAllOfAfter (AbstractIterator const& iterator, std::initializer_list <__Element> const& list) noexcept(false) -> bool;
...
protected:
  ...
  /// \typedef alias for Iterator type
  /// \private
  ...
  template <
      typename __TElementType = ElementType,    // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
      cds::meta::EnableIf <cds::meta::IsCopyConstructible <__TElementType>::value> = 0
  > auto insertBefore (Iterator const& iterator, ElementType const& element) noexcept(false) -> bool;
  ...
  template <
      typename __TElementType = ElementType,    // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
      cds::meta::EnableIf <cds::meta::IsMoveConstructible <__TElementType>::value> = 0
  > auto insertBefore (Iterator const& iterator, ElementType&& element) noexcept(false) -> bool;
  ...
  template <
      typename __TElementType = ElementType,    // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
      cds::meta::EnableIf <cds::meta::IsCopyConstructible <__TElementType>::value> = 0
  > auto insertAfter (Iterator const& iterator, ElementType const& element) noexcept(false) -> bool;
  ...
  template <
      typename __TElementType = ElementType,    // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
      cds::meta::EnableIf <cds::meta::IsMoveConstructible <__TElementType>::value> = 0
  > auto insertAfter (Iterator const& iterator, ElementType&& element) noexcept(false) -> bool;
  ...
  /// \public
  template <typename...__Arguments> // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
  auto emplaceBefore (Iterator const& iterator, __Arguments&&... parameters) noexcept(false) -> bool;
  ...
  /// \public
  template <typename...__Arguments> // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
  auto emplaceAfter (Iterator const& iterator, __Arguments&&... parameters) noexcept(false) -> bool;
  ...
  /// \public
  template <typename...__Arguments> // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
  auto insertAllBefore (Iterator const& iterator, __Arguments&&... values) noexcept(false) -> bool;
  ...
  /// \public
  template <typename...__Arguments> // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
  auto insertAllAfter (Iterator const& iterator, __Arguments&&... values) noexcept(false) -> bool;
  ...
  template <
      typename __IterableType, // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
      cds::meta::EnableIf <meta::__IterableSizeAvailable <__IterableType>::value> = 0
  > auto insertAllOfBefore (Iterator const& iterator, __IterableType const& iterable) noexcept(false) -> bool;
  ...
  template <
      typename __TElementType = __Element, // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
      cds::meta::EnableIf <cds::meta::IsCopyConstructible <__TElementType>::value> = 0
  > auto insertAllOfBefore (Iterator const& iterator, std::initializer_list <__Element> const& list) noexcept(false) -> bool;
  ...
  template <
      typename __IterableType, // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
      cds::meta::EnableIf <meta::__IterableSizeAvailable <__IterableType>::value> = 0
  > auto insertAllOfAfter (Iterator const& iterator, __IterableType const& iterable) noexcept(false) -> bool;
  ...
  template <
      typename __TElementType = __Element, // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
      cds::meta::EnableIf <cds::meta::IsCopyConstructible <__TElementType>::value> = 0
  > auto insertAllOfAfter (Iterator const& iterator, std::initializer_list <__Element> const& list) noexcept(false) -> bool;
