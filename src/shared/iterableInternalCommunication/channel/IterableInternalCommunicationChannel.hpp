...
#include "../IterableInternalRequestType.hpp"              /* NOLINT(llvm-include-order) */
    ...
    namespace __hidden {    /* NOLINT(modernize-concat-nested-namespaces, bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp) */
        namespace __impl {  /* NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp) */
            ...
            protected:                                                                  /* NOLINT(readability-redundant-access-specifiers) */
                 ...
                 */
                using __GenericHandler      = functional :: ConsumerFunction < __ReceiverType * >;    /* NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp) */
            ...
            protected:                                                                          /* NOLINT(readability-redundant-access-specifiers) */
                 ...
                 * @protected to be reused in the deriving classes to keep type consistency
                 */
                using __GenericConstHandler = functional :: ConsumerFunction < __ReceiverType const * >;    /* NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp) */
            ...
            protected:                                                                                  /* NOLINT(readability-redundant-access-specifiers) */
                 ...
                 * @param [in] requestType : __IterableInternalRequestType = The Type of Handler ( member-function ) requested from the derived class
                 * @exceptsafe
            ...
            protected:                                                                                          /* NOLINT(readability-redundant-access-specifiers) */
                 ...
                 * @param [in] requestType : __IterableInternalRequestType = The Type of Const Handler ( member-const-function ) requested from the derived class
                 * @exceptsafe
            ...
            protected:  /* NOLINT(readability-redundant-access-specifiers) */
                ...
                constexpr __IterableInternalCommunicationChannel (
                        __IterableInternalCommunicationChannel const & /* channel */
                ) noexcept = default;
            ...
            protected:  /* NOLINT(readability-redundant-access-specifiers) */
                 ...
                 */
                constexpr __IterableInternalCommunicationChannel (
                        __IterableInternalCommunicationChannel && /* channel */
                ) noexcept = default;
