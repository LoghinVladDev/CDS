...
///      )
///
/// \tparam __Receiver is the type of the interface ( HashMapEntryProxy / HashMapValueProxy / ... )
/// \tparam __Element is the type enclosed in the interface collection ( int from Array \< int \> )
///
