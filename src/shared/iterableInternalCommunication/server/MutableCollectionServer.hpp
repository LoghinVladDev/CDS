...
#ifndef __CDS_SHARED_MUTABLE_COLLECTION_SERVER_HPP__ /* NOLINT(llvm-header-guard) */
#define __CDS_SHARED_MUTABLE_COLLECTION_SERVER_HPP__ /* NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp) */
...
namespace cds {             /* NOLINT(modernize-concat-nested-namespaces) */
    namespace __hidden {    /* NOLINT(modernize-concat-nested-namespaces, bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp) */
        namespace __impl {  /* NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp) */
            ...
            > class __MutableCollectionServer { /* NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp) */
            ...
            private:    /* NOLINT(readability-redundant-access-specifiers) */
                 ...
                 * @private
                 */
                using __GenericHandler      = functional :: ConsumerFunction < Iterable < __ElementType > * >;    /* NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp) */
            ...
            private:    /* NOLINT(readability-redundant-access-specifiers) */
                 ...
                 * @private
                 */
                using __GenericConstHandler = functional :: ConsumerFunction < Iterable < __ElementType > const * >;    /* NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp) */
            ...
            protected:  /* NOLINT(readability-redundant-access-specifiers) */
                 ...
                 * @protected
                 */
                __CDS_NoDiscard constexpr auto __mcs_handlers () const noexcept -> __GenericHandler const *; /* NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp) */
            ...
            protected:  /* NOLINT(readability-redundant-access-specifiers) */
                 ...
                 * @protected
                 */
                __CDS_NoDiscard constexpr auto __mcs_constHandlers () const noexcept -> __GenericConstHandler const *;   /* NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp) */
            };
