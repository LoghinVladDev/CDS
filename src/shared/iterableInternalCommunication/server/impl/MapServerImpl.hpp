...
typename __MapServer <__ReceiverType, __ElementType>::__GenericHandler const __MapServer <  // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp, *-c-arrays)
...
>::__routingTable [static_cast <uint32> (__IterableInternalRequest::__iir_requestCountDoNotUse)] = {  // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp, *-c-arrays)
    bitCast <__GenericHandler> (&__ReceiverType::__begin),              // __cirt_begin                         - expected part of Map        // NOLINT(*-reinterpret-cast)
    bitCast <__GenericHandler> (&__ReceiverType::__end),                // __cirt_end                           - expected part of Map        // NOLINT(*-reinterpret-cast)
    nullptr,                                                                            // __cirt_rbegin                        - not expected part of Map
    nullptr,                                                                            // __cirt_rend                          - not expected part of Map
    bitCast <__GenericHandler> (&__ReceiverType::__remove),             // __cirt_remove                        - not expected part of Map    // NOLINT(*-reinterpret-cast)
    bitCast <__GenericHandler> (&__ReceiverType::__removeConst),        // __cirt_removeConst                   - expected part of Map        // NOLINT(*-reinterpret-cast)
    bitCast <__GenericHandler> (&__ReceiverType::__removeArray),        // __cirt_removeArray                   - expected part of Map        // NOLINT(*-reinterpret-cast)
    bitCast <__GenericHandler> (&__ReceiverType::__removeConstArray),   // __cirt_removeConstArray              - expected part of Map        // NOLINT(*-reinterpret-cast)
    bitCast <__GenericHandler> (&__ReceiverType::__newAddress),         // __cirt_newAddress                    - expected part of Map        // NOLINT(*-reinterpret-cast)
    ...
    bitCast <__GenericHandler> (&__ReceiverType::__find),               // __cirt_find                          - not expected part of Map    // NOLINT(*-reinterpret-cast)
    nullptr,                                                                            // __cirt_findConst                     - expected part of Map
};


template <typename __ReceiverType, typename __ElementType>  // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
typename __MapServer <__ReceiverType, __ElementType>::__GenericConstHandler const __MapServer < // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp, *-c-arrays)
    __ReceiverType, __ElementType
>::__constRoutingTable [static_cast <uint32> (__IterableInternalRequest::__iir_requestCountDoNotUse)] = {  // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp, *-c-arrays)
    bitCast <__GenericConstHandler> (&__ReceiverType::__cbegin),    // __cirt_begin                         - expected part of Map        // NOLINT(*-reinterpret-cast)
    bitCast <__GenericConstHandler> (&__ReceiverType::__cend),      // __cirt_end                           - expected part of Map        // NOLINT(*-reinterpret-cast)
    nullptr,                                                                        // __cirt_rbegin                        - not expected part of Map
    nullptr,                                                                        // __cirt_rend                          - not expected part of Map
    ...
    bitCast <__GenericConstHandler> (&__ReceiverType::__findConst)  // __cirt_findConst                     - expected part of Map        // NOLINT(*-reinterpret-cast)
};


template <typename __ReceiverType, typename __ElementType>  // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
constexpr auto __MapServer <__ReceiverType, __ElementType>::__ms_handlers () const noexcept -> __GenericHandler const* {
...
template <typename __ReceiverType, typename __ElementType>  // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
constexpr auto __MapServer <__ReceiverType, __ElementType>::__ms_constHandlers () const noexcept -> __GenericConstHandler const* {
