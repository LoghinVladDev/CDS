...
///      )
///
/// \tparam __Receiver is the type of the interface ( HashSet / LinkedHashSet / TreeSet / ... )
/// \tparam __Element is the type enclosed in the interface collection ( int from HashSet \< int \> )
///
/// \test All Tests involving Collections apply
/// \test Suite: CTS-00001, Group: All, Test Cases: All
/// \test Suite: STS-00001, Group: All, Test Cases: All
///
