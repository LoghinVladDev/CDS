...
#pragma pop_macro("min")
    ...
    __CDS_cpplang_ConstexprDynamicAllocation auto append (sint16 v) noexcept -> String & {
        ...
        Conversion::toCharBase10( this->_p + this->_l + static_cast < uint8 > (negative), length, uValue );
    ...
    __CDS_cpplang_ConstexprDynamicAllocation auto append (uint8 v) noexcept -> String & {
        ...
        Conversion::toCharBase10(this->_p + this->_l, length, v);
        this->_l += length;
        return * this;
    }
...
public:
     ...
     * @test tested in primitive/StringTest/Utility Functions, String Formatting
     */
    __CDS_cpplang_ConstexprConditioned auto static isConsonant(char c) noexcept -> bool { return isLetter(c) && ! isVowel(c); }
...
public:
    ...
    __CDS_MaybeUnused __CDS_cpplang_ConstexprConditioned auto forEach ( Action const & a ) noexcept ( noexcept ( ( * dataTypes :: unsafeAddress < Action > () ) ( Type < char > :: unsafeReference() ) ) ) -> String & {
        for ( Index i = 0; i < this->_l; ++ i )
            a ( this->_p[i] );
     ...
     */
    template < typename Action >
    __CDS_MaybeUnused __CDS_cpplang_ConstexprConditioned auto forEach ( Action const & a ) const noexcept ( noexcept ( ( * dataTypes :: unsafeAddress < Action > () ) ( Type < const char > :: unsafeReference() ) ) ) -> String const & {
        for ( Index i = 0; i < this->_l; ++ i )
            a ( this->_p[i] );
    ...
    __CDS_MaybeUnused __CDS_cpplang_ConstexprConditioned auto some ( Predicate const & p, Size s ) noexcept ( noexcept ( ( * dataTypes :: unsafeAddress < Predicate > () ) ( Type < char > :: unsafeReference() ) ) ) -> bool { return s <= this->count ( p ); }
     ...
     */
     template < typename Predicate >
    __CDS_MaybeUnused __CDS_cpplang_ConstexprConditioned auto some ( Predicate const & p, Size s ) const noexcept( noexcept ( ( * dataTypes :: unsafeAddress < Predicate > () ) ( Type < const char > :: unsafeReference() ) ) ) -> bool { return s <= this->count ( p ); }
     ...
     */
    template < typename Predicate >
    __CDS_MaybeUnused __CDS_cpplang_ConstexprConditioned auto any ( Predicate const & p ) noexcept ( noexcept ( ( * dataTypes :: unsafeAddress < Predicate > () ) ( Type < char > :: unsafeReference() ) ) ) -> bool { return 1u <= this->count(p); }
     ...
     */
    template < typename Predicate >
    __CDS_MaybeUnused __CDS_cpplang_ConstexprConditioned auto any ( Predicate const & p ) const noexcept ( noexcept ( ( * dataTypes :: unsafeAddress < Predicate > () ) ( Type < const char > :: unsafeReference() ) ) ) -> bool { return 1u <= this->count(p); }
     ...
     */
    template < typename Predicate >
    __CDS_MaybeUnused __CDS_cpplang_ConstexprConditioned auto all ( Predicate const & p ) noexcept ( noexcept ( ( * dataTypes :: unsafeAddress < Predicate > () ) ( Type < char > :: unsafeReference() ) ) ) -> bool { return this->size() == this->count(p); }
     ...
     */
    template < typename Predicate >
    __CDS_MaybeUnused __CDS_cpplang_ConstexprConditioned auto all ( Predicate const & p ) const noexcept ( noexcept ( ( * dataTypes :: unsafeAddress < Predicate > () ) ( Type < const char > :: unsafeReference() ) ) ) -> bool { return this->size() == this->count(p); }
