...
//    explicit String(std::string const &, Index, Size = UINT64_MAX) noexcept;
    ...
    explicit String (CDS_uint8 v) noexcept : String(String().append(v)) { }
    explicit String (CDS_uint16 v) noexcept : String(String().append(v)) { }
    explicit String (CDS_uint32 v) noexcept : String(String().append(v)) { }
    explicit String (CDS_uint64 v) noexcept : String(String().append(v)) { }

    explicit String (CDS_sint8 v) noexcept : String(String().append(v)) { }
    explicit String (CDS_sint16 v) noexcept : String(String().append(v)) { }
    explicit String (CDS_sint32 v) noexcept : String(String().append(v)) { }
    explicit String (CDS_sint64 v) noexcept : String(String().append(v)) { }

    explicit String (float v) noexcept : String(String().append(v)) { }
    explicit String (double v) noexcept : String(String().append(v)) { }
