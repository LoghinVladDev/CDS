...
namespace cds {
    ...
    public:
        ...
        Atomic ( Double const & v ) noexcept : // NOLINT(google-explicit-constructor)
                utility :: hidden :: doubleAtomicImpl :: Base (v) {

        }

        Atomic (double v) noexcept { // NOLINT(google-explicit-constructor,clion-misra-cpp2008-12-1-3)
            this->set(v);
        }
