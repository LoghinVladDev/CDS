...
public:
  ...
  template <typename E0 = E, EnableIf<IsDefaultConstructible<E0>> = 0> CDS_ATTR(constexpr(11))
  ...
  template <typename T, typename... Args> CDS_ATTR(2(explicit, constexpr(11)))
...
template <typename E> CDS_ATTR(2(nodiscard, constexpr(11))) auto unexpected(E&& error)
...
template <typename E, typename... Args> CDS_ATTR(2(nodiscard, constexpr(11))) auto unexpected(Args&&... args)
