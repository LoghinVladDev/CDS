...
#ifndef __CDS_STRING_VIEW_BASE_ABSTRACT_CONST_ITERATOR_IMPL_HPP__
#define __CDS_STRING_VIEW_BASE_ABSTRACT_CONST_ITERATOR_IMPL_HPP__
...
#endif // __CDS_STRING_VIEW_BASE_ABSTRACT_CONST_ITERATOR_IMPL_HPP__
