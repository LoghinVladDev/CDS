...
public:
  ...
  __BaseString (__BaseString const& string) noexcept;
  ...
  > __CDS_Implicit __BaseString (__BaseString <__OtherCharType> const& string) noexcept;  // NOLINT(*-explicit-*)

  constexpr __BaseString (__BaseString&& string) noexcept;
  __CDS_Implicit __BaseString (__BaseStringView <__CharType> const& string) noexcept; // NOLINT(*-explicit-*)
 
  template <
      typename __OtherCharType,   // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
      meta::EnableIf <meta::IsStringCharType <__OtherCharType>::value && !meta::IsSame <__OtherCharType, __CharType>::value> = 0
  > __CDS_Implicit __BaseString (__BaseStringView <__OtherCharType> const& string) noexcept;  // NOLINT(*-explicit-*)
 
  __CDS_Implicit __BaseString (ElementType const* pString) noexcept;  // NOLINT(*-explicit-*)
 
  __CDS_Implicit __BaseString (std::basic_string <__CharType> const& string) noexcept;  // NOLINT(*-explicit-*)

  __BaseString (ElementType const* pString, Size length) noexcept;
 
  template <
      typename __OtherCharType,   // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
      meta::EnableIf <meta::IsStringCharType <__OtherCharType>::value && !meta::IsSame <__OtherCharType, __CharType>::value> = 0
  > __CDS_Implicit __BaseString (__OtherCharType const* pString) noexcept;  // NOLINT(*-explicit-*)
 
  template <
      typename __OtherCharType,   // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
      meta::EnableIf <meta::IsStringCharType <__OtherCharType>::value && !meta::IsSame <__OtherCharType, __CharType>::value> = 0
  > __BaseString (__OtherCharType const* pString, Size length) noexcept;

  __CDS_Implicit __BaseString (Object const& object) noexcept;  // NOLINT(*-explicit-*)
 
  __BaseString (Size length, ElementType fillCharacter) noexcept;
 
  template <
      typename __OtherCharType,   // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
      meta::EnableIf <meta::IsStringCharType <__OtherCharType>::value && !meta::IsSame <__OtherCharType, __CharType>::value> = 0
  > __BaseString (Size length, __OtherCharType fillCharacter) noexcept;
 
  template <
      typename __IteratorType,    // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
      meta::EnableIf <meta::IsIterator <__IteratorType>::value> = 0
  > __BaseString (__IteratorType const& begin, __IteratorType const& end) noexcept;
 
  __CDS_Implicit __BaseString (std::initializer_list <ElementType> const& initializerList) noexcept;
 
  template <
      typename __OtherCharType,   // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
      meta::EnableIf <meta::IsStringCharType <__OtherCharType>::value && !meta::IsSame <__OtherCharType, __CharType>::value> = 0
  > __CDS_Implicit __BaseString (std::initializer_list <__OtherCharType> const& initializerList) noexcept;

#if defined(CDS_QT)
  __BaseString (QString const& string) noexcept;
#endif
  ...
  __CDS_Implicit __BaseString (ElementType value) noexcept; // NOLINT(*-explicit-*)
  ...
  __CDS_Implicit __BaseString (__NumericType value) noexcept; // NOLINT(*-explicit-*)
 
  __CDS_Implicit __BaseString (bool value) noexcept;  // NOLINT(*-explicit-*)
  ...
  __CDS_Implicit __BaseString (__FloatingPointType value) noexcept; // NOLINT(*-explicit-*)
  ...
  __CDS_Explicit __BaseString (__AddressType const* address) noexcept;
  ...
  auto resize (Size size) noexcept -> void;
  auto reserve (Size size) noexcept -> void;
  auto shrink (Size size = limits::U64_MAX) noexcept -> void;
  ...
  __CDS_NoDiscard auto substr (Index from, Index until = -1) const noexcept -> __BaseString;
  __CDS_NoDiscard auto operator () (Index from, Index until = -1) const noexcept -> __BaseString;
  ...
  > auto operator = (__ConvertibleType&& string) noexcept -> __BaseString&;

  auto operator = (__BaseString const& string) noexcept -> __BaseString&;
  auto operator = (__BaseString&& string) noexcept -> __BaseString&;
  auto operator = (__BaseStringView <ElementType> const& string) noexcept -> __BaseString&;
  ...
  auto operator = (ElementType character) noexcept -> __BaseString&;
 
  template <typename __NumericType, meta::EnableIf <meta::IsIntegralToString <__CharType, __NumericType>::value> = 0>   // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
  auto operator = (__NumericType value) noexcept -> __BaseString&;

  auto operator = (bool value) noexcept -> __BaseString&;
 
  template <typename __FloatingPointType, meta::EnableIf <meta::IsFloatingPoint <__FloatingPointType>::value> = 0>  // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
  auto operator = (__FloatingPointType value) noexcept -> __BaseString&;
  ...
  auto operator += (__BaseString&& string) noexcept -> __BaseString&;
  auto operator += (__BaseStringView <__CharType> const& string) noexcept -> __BaseString&;

#if defined(CDS_QT)
  auto operator += (QString const& string) noexcept -> __BaseString&;
#endif
  ...
  template <typename __ConvertibleType, meta::EnableIf <meta::IsConvertibleToBaseStringView <__ConvertibleType, __CharType>::value> = 0>    // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
  auto operator + (__ConvertibleType&& string) const& noexcept -> __BaseString;

  auto operator + (__BaseString&& string) const& noexcept -> __BaseString;
  auto operator + (__BaseStringView <__CharType> const& string) const& noexcept -> __BaseString;

#if defined(CDS_QT)
  auto operator + (QString const& string) const& noexcept -> __BaseString;
#endif
 
  template <typename __TCharType = __CharType, meta::EnableIf <meta::IsStringCharType <__TCharType>::value> = 0>    // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
  auto operator + (ElementType character) const& noexcept -> __BaseString;
 
  template <typename __NumericType, meta::EnableIf <meta::IsIntegralToString <__CharType, __NumericType>::value> = 0>   // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
  auto operator + (__NumericType value) const& noexcept -> __BaseString;

  auto operator + (bool value) const& noexcept -> __BaseString;
 
  template <typename __FloatingPointType, meta::EnableIf <meta::IsFloatingPoint <__FloatingPointType>::value> = 0>  // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
  auto operator + (__FloatingPointType value) const& noexcept -> __BaseString;
  ...
  auto operator * (int repeatCount) const& noexcept -> __BaseString;
  auto operator * (int repeatCount)&& noexcept -> __BaseString;
 
  template <typename __ConvertibleType, meta::EnableIf <meta::IsConvertibleToBaseStringView <__ConvertibleType, __CharType>::value> = 0>    // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
  auto append (__ConvertibleType&& string) noexcept -> __BaseString&;

  auto append (__BaseString&& string) noexcept -> __BaseString&;
  auto append (__BaseStringView <__CharType> const& string) noexcept -> __BaseString&;

#if defined(CDS_QT) 
  auto append (QString const& string) noexcept -> __BaseString&;
#endif
 
  template <typename __TCharType = __CharType, meta::EnableIf <meta::IsStringCharType <__TCharType>::value> = 0>    // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
  auto append (ElementType character) noexcept -> __BaseString&;
 
  template <typename __NumericType, meta::EnableIf <meta::IsIntegralToString <__CharType, __NumericType>::value> = 0>   // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
  auto append (__NumericType value) noexcept -> __BaseString&;

  auto append (bool value) noexcept -> __BaseString&;
 
  template <typename __FloatingPointType, meta::EnableIf <meta::IsFloatingPoint <__FloatingPointType>::value> = 0>  // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
  auto append (__FloatingPointType value) noexcept -> __BaseString&;
 
  template <typename __ConvertibleType, meta::EnableIf <meta::IsConvertibleToBaseStringView <__ConvertibleType, __CharType>::value> = 0>    // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
  auto prepend (__ConvertibleType&& string) noexcept -> __BaseString&;

  auto prepend (__BaseString&& string) noexcept -> __BaseString&;

  auto prepend (__BaseStringView <__CharType> const& string) noexcept -> __BaseString&;

#if defined(CDS_QT)
  auto prepend (QString const& string) noexcept -> __BaseString&;
#endif
 
  template <typename __TCharType = __CharType, meta::EnableIf <meta::IsStringCharType <__TCharType>::value> = 0>    // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
  auto prepend (ElementType character) noexcept -> __BaseString&;
 
  template <typename __NumericType, meta::EnableIf <meta::IsIntegralToString <__CharType, __NumericType>::value> = 0>   // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
  auto prepend (__NumericType value) noexcept -> __BaseString&;

  auto prepend (bool value) noexcept -> __BaseString&;
 
  template <typename __FloatingPointType, meta::EnableIf <meta::IsFloatingPoint <__FloatingPointType>::value> = 0>  // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
  auto prepend (__FloatingPointType value) noexcept -> __BaseString&;
  ...
  template <typename __ConvertibleType, meta::EnableIf <meta::IsConvertibleToBaseStringView <__ConvertibleType, __CharType>::value> = 0>    // NOLINT(bugprone-reserved-identifier, cert-dcl37-c, cert-dcl51-cpp)
  auto replace (Index from, Index until, __ConvertibleType&& inPlace) noexcept -> __BaseString&;
  auto replace (Index from, Index until, __BaseStringView <__CharType> const& inPlace) noexcept -> __BaseString&;
