...
#ifndef __CDS_STRING_BASE_CONST_ITERATOR_HPP__
#define __CDS_STRING_BASE_CONST_ITERATOR_HPP__
...
namespace cds { // NOLINT(modernize-concat-nested-namespaces)
    namespace __hidden { // NOLINT(modernize-concat-nested-namespaces, bugprone-reserved-identifier)
        namespace __impl { // NOLINT(bugprone-reserved-identifier)
            ...
            class __BaseString < __CharType > :: ConstIterator : public AbstractConstIterator {
...
#endif // __CDS_STRING_BASE_CONST_ITERATOR_HPP__
