...
__BaseString < __CharType >::__BaseString (
  ...
  this->_pBuffer      = StringUtils < __CharType >::copy (
      __Alloc::__alloc (this->_capacity),
      0ULL,
      string.cStr(),
      0ULL,
      this->_length
...
__BaseString < __CharType >::__BaseString (
  ...
  this->_pBuffer  = __Alloc::__alloc ( this->_capacity );
...
auto __BaseString < __CharType >::resize (
  ...
  this->_pBuffer = __Alloc::__realloc (this->_length + 1u, this->_pBuffer, this->_capacity);
...
auto __BaseString < __CharType >::operator = (
  ...
  if ( string.empty() ) {
    __Alloc::__free ( cds::exchange ( this->_pBuffer, nullptr ) );
    this->_length   = 0ULL;
    this->_capacity = 0ULL;
...
__CDS_OptimalInline auto __BaseString < __CharType >::operator = (
  ...
  this->_pBuffer = __Alloc::__enlarge (
      this->_pBuffer,
      this->_capacity,
      2ULL,
      & this->_capacity
...
__CDS_OptionalInline auto operator * (
  ...
  string._pBuffer = __Alloc::__enlarge (
      string._pBuffer,
      string._capacity,
...
auto __BaseString < __CharType >::prepend (
  ...
  auto newBuffer = __Alloc::__alloc ( this->_capacity );
  ...
  this->_length = newLength;
  __Alloc::__free ( cds::exchange ( this->_pBuffer, newBuffer ) );
...
__CDS_OptimalInline auto __BaseString < __CharType >::join (
  ...
  result._pBuffer = __Alloc::__alloc (
      result._capacity
  );
