...
TEST(MetaBase, SignedEquivalent) {
  ...
  static_assert(IsSame<S64, SignedEquivalent<unsigned long long>>::value, "Failed SignedEquivalent");
...
TEST(MetaBase, UnsignedEquivalent) {
  ...
  static_assert(IsSame<U64, UnsignedEquivalent<long long>>::value, "Failed UnsignedEquivalent");
